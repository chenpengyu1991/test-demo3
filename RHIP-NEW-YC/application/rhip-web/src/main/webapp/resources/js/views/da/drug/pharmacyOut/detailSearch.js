var detailSearch = (function() {
    ...
    function search(pageIndex) {
    	var beginDt = $('#pharmacyOutDetailDiv').find('#beginDt').val();
    	var endDt = $('#pharmacyOutDetailDiv').find('#endDt').val();
    	var batchNo = $('#pharmacyOutDetailDiv').find('#batchNo').val();
        pageIndex = ($.isEmpty(pageIndex)?$("#detailPageIndex").val():pageIndex);
        var searchObj = {
            url : "/da/drug/pharmacyOut/detail/list",
