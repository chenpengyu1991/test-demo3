var pharmacySearch = (function() {
	var validate=null;
    $(function() {
    	validate = $("#pharmacySearchForm").easyValidate();
        $("#pharmacyBtnSearch").click(function(e) {
            e.preventDefault();
            search(1);
        });
        $("#pharmacySearch").onEnter(search, 1);
        search(1); 
        init();
    });
	function init(){
    ...
    function search(pageIndex) {
        ...
        var searchObj = {
            url : "/da/drug/pharmacy/list",
            insertDiv : "pharmacyResultDiv",
            param : {
                pageIndex : pageIndex
            },
        ...
        $("#pharmacySearchForm").submitFormLoadHtml(searchObj);
    };	
