var detailSearch = (function() {
    ...
    function search(pageIndex) {
    	var beginDt = $('#storageOutDetailDiv').find('#beginDt').val();
    	var endDt = $('#storageOutDetailDiv').find('#endDt').val();
    	var batchNo = $('#storageOutDetailDiv').find('#batchNo').val();
        pageIndex = ($.isEmpty(pageIndex)?$("#detailPageIndex").val():pageIndex);
        var searchObj = {
            url : "/da/drug/storageOut/detail/list",
