	...
	$.widget("ech.multiselect", {
		...
		_create: function ()
		{
			...
			var button = (this.button = $('<button type="button"><span class="ui-icon ui-icon-triangle-2-n-s"></span></button>')).addClass('ui-multiselect ui-widget ui-state-default ui-corner-all').addClass(o.classes).attr({ 'title': el.attr('title'), 'aria-haspopup': true, 'tabIndex': el.attr('tabIndex') }).insertAfter(el),
				...
				menu = (this.menu = $('<div />')).addClass('ui-multiselect-menu ui-widget ui-widget-content ui-corner-all').addClass(o.classes).appendTo(document.body),
		...
		//add tip   2013年8月2日 13:18:18 liuk
		//use title as tip
		_setButtonTip: function (value)
		{
		...
		_bindEvents: function ()
		{
			...
			//liuk 2013年8月2日 13:40:59
			//add validate result tip and class
			//TODO how to show the tip
			self.element.on("validatedEvent", function (event, result, tip)
			{
				if (result){
					button.removeClass("lose");
				} else {
					self._setButtonTip(tip)
		...
		_toggleDisabled: function (flag)
		{
			...
			inputs.attr({ 'disabled': flag, 'arial-disabled': flag }).parent()[ flag ? 'addClass' : 'removeClass' ]('ui-state-disabled');
