...
<div>
	<%--<c:if test="${fromType ne 'calc'}">
		<div class="toolbar">
				<a href="javascript:void(0)" onclick="javascript:echManageSearch.returnSearch()"><b class="fanhui">返回</b></a>
		</div>
	</c:if>--%>
	<div class="postcontent">
		...
		<table class="posttable">
			...
			<tbody>
				...
				<tr align="center">
						<td colspan="2">
						<%-- <input type="button" onclick="javascript:echReport.closeEchCalc();" name="save" value="关 闭" class="btnopr" /> --%>
