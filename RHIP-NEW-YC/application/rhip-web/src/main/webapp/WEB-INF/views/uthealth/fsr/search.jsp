...
<script type="text/javascript">
	 require(['views/uthealth/fsr/search'],function(fsrSearch){
		 fsrSearch.load();
	 });
</script>
...
<div class="section">
 <div class="searchbox">
	<form id="fsrFormId" name="fsrForm" action="" method="post">
		<table id="useSearchTableId">
               <colgroup>
				...
				<tr>
					...
					<td class="colinput">
						<input type="button" id="fsrSearchBut" value="查 询" class="search_btn" />
					</td>
				</tr>
			</tbody>
		</table>
         <table>
              <tr>
                  <td colspan="4" class="colbottom">
                         <span id="fsrSearchSpanId" class="ico-bottom">&nbsp;</span>
                  </td>
              </tr>
         </table>
	</form>
