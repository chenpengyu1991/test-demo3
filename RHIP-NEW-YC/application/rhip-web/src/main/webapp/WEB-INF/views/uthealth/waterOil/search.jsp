...
<script type="text/javascript">
	 require(['views/uthealth/waterOil/search'],function(waterOilSearch){
		 waterOilSearch.load();
	 });
</script>
...
<div class="section">
 <div class="searchbox">
	<form id="waterOilFormId" name="waterOilForm" action="" method="post">
		<table id="useSearchTableId">
               <colgroup>
				...
				<tr>
					...
					<td class="colinput">
						<input type="button" id="waterOilSearchBut" value="查 询" class="search_btn" />
					</td>
				</tr>
			</tbody>
		</table>
         <table>
              <tr>
                  <td colspan="4" class="colbottom">
                         <span id="waterOilSearchSpanId" class="ico-bottom">&nbsp;</span>
                  </td>
              </tr>
         </table>
	</form>
