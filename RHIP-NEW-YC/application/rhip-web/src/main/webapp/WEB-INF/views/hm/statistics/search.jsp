...
<script src="${pageContext.request.contextPath}/js/views/hm/statistics/search.js" type="text/javascript"></script>

<div class="section">
	<div class="toolbar">
            <%-- <a href="javascript:void(0)" id="statistics-export-btn"><b class="export">导出</b></a> --%>
 <div class="x-nav">
				...
				<table id="statisticsSearch">
					...
					<tbody>
						<tr>
							...
							<td class="col-input org_td"> 
		                        ...
		                        <ehr:authorize ifAnyGranted="${ZLNR}">
		                            <ehr:dic-org-list id="orgCode" name="orgCode" width="30%;" cssClass="x-layui-input"/>
		                        </ehr:authorize>
							</td>
						...
						<tr>
							...
							<td>
							<%-- <input type="button" id="statisticsBtnSearch" value="查询"
	...
	<div class="toolbarSection">
		<a href="javascript:void(0)" id="statistics-export-btn"><button class="layui-btn layui-btn-sm" ><i class="layui-icon">&#xe67d;</i>导出</button></a>
	</div>
