...
<head>
   ...
   <script data-main="${pageContext.request.contextPath}/js/util/main_referral_brw" src="${pageContext.request.contextPath}/js/require/require.js"></script>
...
<body>
	<div id="referralBrwDiv" style="width: 100%;height: 100%;"></div>
</body>
</html>