...
<div class="toolbar" style="margin-top: 8px;">
	<!-- <a href="javascript:void(0)" id="hsa-export-btn"><b class="export">导出</b></a> -->
	<a href="javascript:void(0)" id="hsa-export-btn"><button class="layui-btn layui-btn-sm" ><i class="layui-icon">&#xe67d;</i>导出</button></a>
...
<form method="post" id="hsa-add-location-form">
	...
	<div class="postcontent divFixed105" style="top: 60px;">
		...
		<jsp:include page="../add/addLocInfoInput.jsp"></jsp:include>
		<c:forEach items="${locationInfo.businessInfos}" var="_businessInfo">
			<c:set value="${_businessInfo}" var="businessInfo" scope="request"></c:set>
			<jsp:include page="busiInfoView.jsp"></jsp:include>
		</c:forEach>
	</div>
</form>