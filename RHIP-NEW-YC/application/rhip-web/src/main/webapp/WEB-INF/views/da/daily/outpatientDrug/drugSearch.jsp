...
<script src="${pageContext.request.contextPath}/js/views/da/daily/outpatientDrug/drugSearch.js" type="text/javascript"></script>
<div class="toolbar">
    <a href="javascript:void(0)" onclick="outpatientDrugSearch.returnSearch()"><b class="fanhui">返回</b></a>
</div>

	
<div class="section" style="margin:10px 0px 0px 0px">
	<div class="searchbox">
		<input type="hidden" id="drugPageIndex" value="${drugPageIndex}">
		...
		<input type="hidden" id="drugCostSum" value="${drugCostSum}">		
		<form id="drugSearchForm">
               <table id="drugDetailSearch" >
				<colgroup>
				...
				<tbody>
					...
					<tr>
                        ...
                        <td class="colinput">
                        	...
                        	<!-- 只有一个输入框时,回车键会刷新整个页面 -->
                        	<input type="text" id="onenter" style="display:none;"/>
                        </td>						
               ...
               <table>
                <tr>
                    <td colspan="6" class="colbottom">
                          <span onclick="daCommon.toggle(this,'drugDetailSearch')" class="ico-bottom">&nbsp;</span>
                    </td>
                </tr>
			</table>
		 </form>
