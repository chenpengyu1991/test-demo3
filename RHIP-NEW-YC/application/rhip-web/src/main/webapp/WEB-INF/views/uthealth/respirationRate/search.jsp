...
<script type="text/javascript">
	 require(['views/uthealth/respirationRate/search'],function(respirationRate){
         respirationRate.load();
	 });
</script>

<div class="section">
 <div class="searchbox">
	<form id="respirationRateFormId" name="waterOilForm" action="" method="post">
         ...
         <table>
              <tr>
                  <td colspan="4" class="colbottom">
                         <span id="respirationRateSearchSpanId" class="ico-bottom">&nbsp;</span>
                  </td>
              </tr>
         </table>
	</form>
