		...
		<tbody>
			<c:forEach var="unusual" items="${unusuals}" varStatus="status">
				<tr>
					...
					<%--20150521 刘洋 国家互联互通成熟度标准--%>
					<td class="centertd"><ehr:tip><ehr:dic dicmeta="CV0600101" code="${unusual.cmType}"/></ehr:tip></td>
					...
					<%--<td class="centertd">
						<a href="javascript:void(0)" onclick="unusualSearch.prescription('${unusual.ehrId}','${unusual.recordNumber}')" class="person-link-btn">处方详细</a>
					</td>--%>
				</tr>
			</c:forEach>
			<tr>
			<ehr:pagination action="unusualSearch.search" colspan="7"/>
			</tr>
		</tbody>
	</table>
