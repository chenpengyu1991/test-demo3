...
<script src="${pageContext.request.contextPath}/js/views/phsr/vaccination/search.js" type="text/javascript"></script>
...
<div class="section">
       ...
       <span id="modifyCommunityIdSpan">
		...
		<div class="searchBox">
			...
			<form id="healthVaccinationSearchForm">
				<table id="healthVaccinationSearch">
					<colgroup>
					...
					<tbody>
						<tr>
							...
							<td class="col-input" colspan="3">
								<input type="radio" id="mhmReprtYearId" name="countType"  class="radioGroup" value="1" checked="checked" onclick="healthVaccinationSearch.changeReportType()"/><label for="mhmReprtYearId">按年</label>
                       		 	<input type="radio" id="mhmReprtQuarterId" name="countType"  class="radioGroup" value="2" onclick="healthVaccinationSearch.changeReportType()"/><label for="mhmReprtQuarterId">按季度</label>
                            ...
                            <td style="text-align: right;"><input type="button" id="healthVaccinationBtnSearch" value="查询"
								 class="search_btn" /></td>
						</tr>
					</tbody>
				</table>
		...
		<div id="healthVaccinationResultDiv">
