...
<div class="toolbar">
	...
	<a href="javascript:void(0);" id="modifyPosFTwoSave"><button class="layui-btn layui-btn-sm button"><i class="layui-icon"></i>保存</button></a>
</div>
<div class="Contentbox divFixed105" style="text-align: left;top: 65px;">
    <form id="modifyPosFTwoForm"  method="post">
        <br/>
        <br/>
        <ul>
        ...
        <div class="postcontent">
            <input type="hidden" value="${postpartumDaysHealthInfo.id}" name="id"/>
            <input type="hidden" value="${postpartumDaysHealthInfo.personId}" name="personId"/>
            <input type="hidden" value="${postpartumDaysHealthInfo.createOrganCode}" name="createOrganCode"/>
            <input type="hidden" value="${postpartumDaysHealthInfo.createOrganName}" name="createOrganName"/>
            <table class="posttable">
                ...
                <tr>
                    ...
                    <td><input type="text" reg='{"required":"true"}' id="healthStatus" name="healthStatus" value="${postpartumDaysHealthInfo.healthStatus}" /></td>
                    <th width="15%"><label class="required">一般心理状况</label></th>
                    <td><input type="text" reg='{"required":"true"}' id="psychologicalStatus" name="psychologicalStatus" value="${postpartumDaysHealthInfo.psychologicalStatus}" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <span id="referralReasonText" CLASS="hidediv">&nbsp;&nbsp;&nbsp;原因:<input reg='{"maxlength":"33","required":"true"}' type="text" name="referralReason" value="${postpartumDaysHealthInfo.referralReason}" style="width: 200px;">
