	...
	<table id="person_record_table" class="layui-table x-admin-sm-table-list-middle">
		...
		<thead> 
			<tr>
				...
				<th colspan="2">应随访人数</th>
				<th colspan="2">随访人数</th>
				<th colspan="2">随访人次数</th>
			</tr>
			<tr>
				<th>高血压</th>
				<th>糖尿病</th>
		...
		<tbody> 
			<c:forEach items="${followupMapList}" var="followupMap">
				<tr>
					...
					<td>${followupMap.hbp_plan_num}</td>
					<td>${followupMap.di_plan_num}</td>
					<td>${followupMap.hbp_fllowup_num}</td>
					<td>${followupMap.di_fllowup_num}</td>
