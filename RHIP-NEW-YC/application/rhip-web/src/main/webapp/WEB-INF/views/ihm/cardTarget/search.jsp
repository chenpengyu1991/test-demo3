...
<script src="${pageContext.request.contextPath}/js/views/ihm/cardTarget/cardMonitor.js" type="text/javascript"></script>
<div class="toolbar" >
    <%-- <a onclick="javascript:baseLayoutLoad.loadMenuContent('${pageContext.request.contextPath}/ihm/card/monitor/search');"><b class="fanhui">返回</b></a> --%>
                ...
                <tr>
                    ...
                    <td class="col-input">
                        ...
                        <ehr:authorize ifAnyGranted="02">
                            ...
                            <td rowspan="3">
                                <button class="layui-btn layui-btn-sm"  id="cardBtnSearch"><i class="layui-icon">&#xe615;</i>查询</button>
                            </td>
