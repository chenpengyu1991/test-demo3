...
<script src="${pageContext.request.contextPath}/js/views/idm/statistics/report/acuteReport/month/search.js" type="text/javascript"></script>

<div  class="section">
	<div id="acuteMonthTopAll">
		<div class="toolbar">
			<a href="javascript:void(0)" id="acuteMonthExport"><b class="export">导出</b></a>
	        <%--<a href="javascript:void(0)" id="acuteMonthEdit" style="display: none"><b class="xiug">修改</b></a>--%>
            <a href="javascript:void(0)" id="acuteMonthEdit" style="display: none"><b class="baocun">保存</b></a>
            <a href="javascript:void(0)" id="acuteMonthSave" style="display: none"><b class="baocun">保存</b></a>
		</div> 	
		<div class="searchbox">
			<input type="hidden" id="RoleTypeId" value="${RoleType}"/>
			<form id="acuteMonthSearchForm">				
                <table id="acuteMonthSearch" >
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<td></td>							
	                        <td rowspan="2">
	                            <input type="button" id="acuteMonthBtnSearch" value="汇总" onclick="" class="search_btn"/>
	                        </td> 							
						</tr>
						<tr>								
                            ...
                            <td class="colinput"   colspan="4">
                            	<ehr:authorize ifAnyGranted="${JKFYK}">
	    	                    	...
	    	                    	<input class="radioGroup" onclick="statisticsCommon.changeReportUnit(this.value)" id="reportUnitType93" name="reportUnitType" value="centre" type="radio" ><label for="reportUnitType93">中心</label>
    	                    	</ehr:authorize>                              
                ...
                <table>
	                <tr>
	                    <td colspan="6" class="colbottom">
	                          <span onclick="idmCommon.toggle(this,'acuteMonthSearch')" class="ico-bottom">&nbsp;</span>
	                    </td>
	                </tr>
				</table>
			 </form>
		</div>
		<div id="acuteMonthResultDiv" style="min-width: 750px; min-height:300px;overflow: auto;"></div>
	</div>
	<div id="acuteMonthdetailDiv" ></div>
</div>
