    ...
    <div id="evaluation-main">
        <form id="evaluation-form">
            ...
            <div class="postcontent">
                <div class="postdiv">
                    <fieldset>
                        <legend><label class="required">儿童中医体质辨识</label></legend>
                        <table class="posttable">
                            <colgroup>
                                <col style="width:30%">
                                <col style="width:70%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <tag:autoSelect name="checkOrganCode" id="checkOrganCode"
                                                    reg="{'required':true}"
                                                    codeValue="${exam.checkOrganCode}"
                                                    style="width:300px"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text"
                                           ...
                                           class="layui-input x-admin-sm-date" name="visitDate" id="visitDate" style="padding-left: 0px;width: 38%;" />
                                </td>
                            </tr>
                            <tr>
                                <th><label class="required">中医药健康管理服务</label></th>
                            ...
                            <tr>
                                <th><label class="required">下次随访时间</label></th>
                                <td>
                                    <input type="text"
                                           value="<fmt:formatDate value='${exam.nextSupervisionDate}' pattern='yyyy/MM/dd'/>"
                                           class="layui-input x-admin-sm-date" name="nextSupervisionDate" id="nextSupervisionDate" style="padding-left: 0px;width: 38%;" />
                                </td>
                            </tr>
                            <tr>
