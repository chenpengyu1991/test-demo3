...
<script src="${pageContext.request.contextPath}/js/views/idm/outpatientLog/search.js" type="text/javascript"></script>
            ...
            <colgroup>
                ...
                <tbody>
                  <tr>
                        ...
                        <td class="colinput">
                            <tag:dateInput id="pathogenesisBeginDate" name="pathogenesisBeginDate" pattern="yyyy/MM/dd"  onlypast="true" style="width: 36%;"></tag:dateInput>
                            ~<tag:dateInput nullToToday="true" id="pathogenesisEndDate" name="pathogenesisEndDate" pattern="yyyy/MM/dd"  onlypast="true"  style="width: 36%;"></tag:dateInput>
                        </td>
                        <ehr:authorize ifAnyGranted="${JKFYK},${ADMIN}">
                         	<td class="coltext">机构</td>
	                        <td class="colinput" colspan="2">
	                            <ehr:dic-town-centre-station townId="townOrgCode" centreId="centerOrgCode" stationId="orgCode" townName="townOrgCode" centreName="centerOrgCode" stationName="orgCode" style="width:130px;"/>
	                        </td>
                        </ehr:authorize> 
                    ...
                    <tr>
                        ...
                        <td class="colinput">
                            <ehr:dic-list name="registrationType" dicmeta="P13_13_003"></ehr:dic-list>   
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td class="coltext">初诊/复诊</td>
                        <td class="colinput">
                            <ehr:dic-list name="outpatientType" dicmeta="IDM00409"></ehr:dic-list>   
                        </td>
                        <td align="left">
