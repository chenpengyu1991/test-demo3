...
<div class="section" id="postForTwo">
        ...
        <form id="searchForm">
            <table id="searchTable">
                ...
                <tr>
                    ...
                    <td class="col-input">
                        <input type="text" name="name" style="width:99%;" class="x-layui-input">
                    </td>
                    <td class="col-text">身份证号</td>
                    <td class="col-input">
                        <input type="text" name="idCard" style="width:99%;" class="x-layui-input">
                    </td>
    ...
    <div class="toolbarSection">
        <a id="postpartumFTwoAdd"><button class="layui-btn layui-btn-sm button"><i class="layui-icon"></i>新增</button></a>
    </div>
    </ehr:authorize>
    <div id="womanListDiv">
