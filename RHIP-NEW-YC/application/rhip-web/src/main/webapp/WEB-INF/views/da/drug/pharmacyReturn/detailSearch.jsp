...
<script src="${pageContext.request.contextPath}/js/views/da/drug/pharmacyReturn/detailSearch.js" type="text/javascript"></script>
<div class="toolbar">
    <!-- <a href="javascript:void(0)" onclick="pharmacyReturnSearch.returnSearch()"><b class="fanhui">返回</b></a> -->
    <a href="javascript:void(0)" onclick="pharmacyReturnSearch.returnSearch()"><button class="btn-gray layui-btn layui-btn-sm button"  style="margin-top: 5px;"><i class="layui-icon">&#xe65c;</i>返回</button></a>
</div>
