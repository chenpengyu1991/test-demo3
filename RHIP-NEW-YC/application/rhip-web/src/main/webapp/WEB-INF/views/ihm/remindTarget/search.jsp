...
<script src="${pageContext.request.contextPath}/js/views/ihm/remindTarget/remindStatistics.js" type="text/javascript"></script>
        ...
        <form id="RemindStatisticsForm">
            <table id="targetSearch">
                ...
                <tr>
                    ...
                    <td rowspan="3">
                        <button class="layui-btn layui-btn-sm"  id="remindStatisticsBtnSearch"><i class="layui-icon">&#xe615;</i>查询</button>
                    </td>
