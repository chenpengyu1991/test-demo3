...
<div class="repeattable">
	<table id="person_record_table" class="layui-table x-admin-sm-table-list-middle">
		...
		<thead>
			<tr>
				...
				<th colspan="2">累计体检人数</th>
				<th rowspan="2">体检空血检查人次数</th>
			</tr>
			<tr>
				<th>高血压</th>
				<th>糖尿病</th>
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<td title="${followupMap.create_doctor_code}">
								<ehr:staff-name staffCode="${followupMap.create_doctor_code}"/>
	...
	<table>
		<tr>
			<ehr:pagination action="followupStatistics.pagination" colspan="5"/>
		</tr>
	</table>
</div>
