...
<script src="${pageContext.request.contextPath}/js/views/cdm/standardization/healthPlan/PlanFollowupList.js" type="text/javascript"></script>
<div class="repeattable" id="cdmFollowupAPlanList">
		...
		<table class="repeattable" >
			<thead>
				...
				<tbody>
					<c:forEach var="dmPlanFollowup" items="${dmPlanFollowupList}">
