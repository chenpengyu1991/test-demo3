...
<fieldset>
	...
	<table class="posttable">
		...
		<tr>
			<th><label ${flag!='view'?'class="required"':''}  for="inspGuideTypeName">巡查指导类型</label></th>
			<c:if test="${type!='2'}">
				<td><ehr:dic-list dicmeta="HSA00001" name="inspGuideRecord.inspGuideTypeCode" id="hsa-guide-type" value="${inspRecord.inspGuideRecord.inspGuideTypeCode}" reg="{'required':true}"/>
				</td>
			</c:if>
			<c:if test="${type=='2'}">
				<td><ehr:dic-list dicmeta="HSA00001" name="inspGuideRecord.inspGuideTypeCode" id="hsa-guide-type" value="${inspRecord.inspGuideRecord.inspGuideTypeCode}" reg="{'required':true}" uninclude="1,3,4"/>
				</td>
			</c:if>
		</tr>
		<tr>
			...
			<td colspan="3">
				<div>
					<table class="posttable ${inspRecord.inspGuideRecord.inspGuideTypeCode !=1? 'hide':''}" id="hsa-guide-food">
						<colgroup>
							<col style="width: 7%;" />
							<col style="width: 56%;" />
							<col style="width: 25%;" />
						...
						<tr>
							...
							<td colspan="2" valign="top" style="vertical-align: top;">
								...
								<label >从业人员</label> <input type="text" id="td-praNames" style="width: 120px"  name="inspGuideRecord.praNames" value="${inspRecord.inspGuideRecord.praNames}" ${inspRecord.inspGuideRecord.praNames!=null ? '':'readonly'} reg='{"required":true,"dependOn":"hsa-paramName-type1","maxlength":20}'></input>
										等 <input type="text" style="width: 50px"  name="inspGuideRecord.praCount" value="${inspRecord.inspGuideRecord.praCount}" id="td-praCount" ${inspRecord.inspGuideRecord.praCount!=null ? '':'readonly'}  reg='{"required":true,"dependOn":"hsa-paramName-type1","regex":"digits","maxlength":10}' ></input> 名无健康合格证明和卫生知识培训合格证明
								</c:when>
								<c:otherwise>
						...
						<tr>
							...
							<c:choose >
								<c:when test="${inspRecord.inspGuideRecord.inspGuideTypeCode==1}">
									<input  type="text" name="inspGuideRecord.other" value="${inspRecord.inspGuideRecord.other}" id="td-other1" ${inspRecord.inspGuideRecord.other!=null ? '':'readonly'} reg='{"required":true,"dependOn":"hsa-other1","maxlength":500}'/>
								</c:when>
								<c:otherwise>
					...
					<table class="posttable ${inspRecord.inspGuideRecord.inspGuideTypeCode !=2? 'hide':''}" id="hsa-guide-water">
						<colgroup>
							<col style="width: 8%;" />
							<col style="width: 56%;" />
							<col style="width: 25%;" />
						...
						<tr>
							...
							<td class="${inspRecord.inspGuideRecord.hygienicLicenseWater !=5 &&inspRecord.inspGuideRecord.hygienicLicenseWater !=null ? '':'hide'}" id="td-hygienicLicense"><ehr:dic-radio hideCodes="3,4,5" reg='{"required":"true","extension":["cuValidate","请填写"]}' dicmeta="HSA00003" name="inspGuideRecord.hygienicLicenseWater" value="${inspRecord.inspGuideRecord.hygienicLicenseWater}"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<c:choose >
								<c:when test="${inspRecord.inspGuideRecord.inspGuideTypeCode==2}">
									<input  type="text" name="inspGuideRecord.otherWater" value="${inspRecord.inspGuideRecord.otherWater}" id="td-other2" ${inspRecord.inspGuideRecord.otherWater!=null ? '':'readonly'} reg='{"required":true,"dependOn":"hsa-other2","maxlength":500}'/>
								</c:when>
								<c:otherwise>
					...
					<table class="posttable ${inspRecord.inspGuideRecord.inspGuideTypeCode !=3? 'hide':''}" id="hsa-guide-idp">
						<colgroup>
							<col style="width: 8%;" />
							<col style="width: 56%;" />
							<col style="width: 25%;" />
						...
						<tr>
							...
							<c:choose >
								<c:when test="${inspRecord.inspGuideRecord.inspGuideTypeCode==3}">
									<input  type="text" name="inspGuideRecord.otherIdm" value="${inspRecord.inspGuideRecord.otherIdm}" id="td-other3" ${inspRecord.inspGuideRecord.otherIdm!=null ? '':'readonly'} reg='{"required":true,"dependOn":"hsa-other3","maxlength":500}'/>
								</c:when>
								<c:otherwise>
					...
					<table class="posttable ${inspRecord.inspGuideRecord.inspGuideTypeCode !=4? 'hide':''}" id="hsa-guide-plocation">
						<colgroup>
							<col style="width: 8%;" />
							<col style="width: 56%;" />
							<col style="width: 25%;" />
						...
						<tr>
							...
							<td><label >亮证经营</label></td>
							<td class="${inspRecord.inspGuideRecord.bcbPlace !=5 &&inspRecord.inspGuideRecord.bcbPlace !=null ? '':'hide'}" id="td-pbcb"><ehr:dic-radio hideCodes="3,4,5" reg='{"required":"true","extension":["cuValidate","请填写"]}' dicmeta="HSA00002" name="inspGuideRecord.bcbPlace" value="${inspRecord.inspGuideRecord.bcbPlace}"/></td>
						</tr>
						<tr>
							...
							<td  colspan="2" valign="top" style="vertical-align: top;">
								...
								<label >从业人员</label> <input type="text" id="td-ppraNames" style="width: 120px"  name="inspGuideRecord.praPlaceNames" value="${inspRecord.inspGuideRecord.praPlaceNames}" ${inspRecord.inspGuideRecord.praPlaceNames!=null ? '':'readonly'} reg='{"required":true,"dependOn":"hsa-paramName-type4","maxlength":500}' ></input>
										等 <input type="text" style="width: 50px"  name="inspGuideRecord.praPlaceCount" value="${inspRecord.inspGuideRecord.praPlaceCount}" id="td-ppraCount" ${inspRecord.inspGuideRecord.praPlaceCount!=null ? '':'readonly'} reg='{"required":true,"dependOn":"hsa-paramName-type4","regex":"digits","maxlength":10}' ></input> 名无健康合格证明和卫生知识培训合格证明
								</c:when>
								<c:otherwise>
						...
						<tr>
							...
							<td><label >配备除“四害”防治设施、开展除“四害”活动</label></td>
							<td class="${inspRecord.inspGuideRecord.wfcfPlace !=5 &&inspRecord.inspGuideRecord.wfcfPlace !=null ? '':'hide'}" id="td-pwfcf"><ehr:dic-radio hideCodes="3,4,5" reg='{"required":"true","extension":["cuValidate","请填写"]}' dicmeta="HSA00002" name="inspGuideRecord.wfcfPlace" value="${inspRecord.inspGuideRecord.wfcfPlace}"/></td>
						</tr>
						<tr>
							...
							<c:choose >
								<c:when test="${inspRecord.inspGuideRecord.inspGuideTypeCode==4}">
									<input  type="text" name="inspGuideRecord.otherPlace" value="${inspRecord.inspGuideRecord.otherPlace}" id="td-other4"    ${inspRecord.inspGuideRecord.otherPlace!=null ? '':'readonly'} reg='{"required":true,"dependOn":"hsa-other4","maxlength":500}'/>
								</c:when>
								<c:otherwise>
