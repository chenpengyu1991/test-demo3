...
<div class="toolbar">
	...
	<a href="javascript:void(0)" id="pFOBackViewId"><button class="btn-gray layui-btn layui-btn-sm button"><i class="layui-icon">&#xe65c;</i>返回</button></a>
	</c:if>
</div>
			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<c:if test="${prenatalFollowupOther.screeningIsHighTwo!=null}">高危</c:if><ehr:dic code="${prenatalFollowupOther.screeningIsHighTwo}" dicmeta="FS10281"/>
					</td>
					<td>
						<ehr:dic code="${prenatalFollowupOther.screeningThree}" dicmeta="FS10281"/>
						<c:if test="${prenatalFollowupOther.screeningIsHighThree!=null}">高危</c:if><ehr:dic code="${prenatalFollowupOther.screeningIsHighThree}" dicmeta="FS10281"/>
					</td>
					<td></td>
					<td></td>
				</tr>
				<tr>
					...
					<td>
						...
						<c:if test="${prenatalFollowupOther.diagnosisIsConfirmedTwo!=null}">确诊</c:if><ehr:dic code="${prenatalFollowupOther.diagnosisIsConfirmedTwo}" dicmeta="FS10281"/>
					</td>
					<td>
						<ehr:dic code="${prenatalFollowupOther.diagnosisThree}" dicmeta="FS10281"/>
						<c:if test="${prenatalFollowupOther.diagnosisIsConfirmedThree!=null}">确诊</c:if><ehr:dic code="${prenatalFollowupOther.diagnosisIsConfirmedThree}" dicmeta="FS10281"/>
					</td>
					<td></td>
					<td></td>
				</tr>
				...
				<tr>
					<th>转诊</th>
					<td>
						<ehr:dic code="${prenatalFollowupOther.referralFlagTwo}" dicmeta="FY0001"/>
						<c:if test="${prenatalFollowupOther.referralFlagTwo eq '1'}">
							<br/>
					...
					<td>
						<ehr:dic code="${prenatalFollowupOther.referralFlagThree}" dicmeta="FY0001"/>
						<c:if test="${prenatalFollowupOther.referralFlagThree eq '1'}">
							<br/>
					...
					<td>
						<ehr:dic code="${prenatalFollowupOther.referralFlagFour}" dicmeta="FY0001"/>
						<c:if test="${prenatalFollowupOther.referralFlagFour eq '1'}">
							<br/>
					...
					<td>
						<ehr:dic code="${prenatalFollowupOther.referralFlagFive}" dicmeta="FY0001"/>
						<c:if test="${prenatalFollowupOther.referralFlagFive eq '1'}">
							<br/>
