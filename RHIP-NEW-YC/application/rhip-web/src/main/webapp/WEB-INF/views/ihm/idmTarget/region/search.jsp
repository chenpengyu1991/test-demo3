...
<!-- <script type="text/javascript">
	require(['views/ihm/idmTarget/region/search'],function(regionSearch) {
		regionSearch.load();
		});
</script>  -->
				...
				<tbody>
					<tr>
						...
						<td class="col-input">
					 	...
					 	<td rowspan="2">
							<button class="layui-btn layui-btn-sm"  id="idmBtnSearch"><i class="layui-icon">&#xe615;</i>查询</button>
						</td> 
					</tr>
					...
					<tr>
						...
						<td class="col-input">
		                    ...
		                    <div id="byWeek">
                        		...
                        		<select name="weekSelect" id="weekSelect" style="width: 250px;"></select> 
							</div>								
		                    <div id="byMonth">
