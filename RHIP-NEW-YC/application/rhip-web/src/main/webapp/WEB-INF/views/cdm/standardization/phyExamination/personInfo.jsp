...
<fieldset class="layui-elem-field" style="margin-top: 10px;">
	...
	<input type="hidden" id="cdm-perphyexam-list-personid-input" name="personInfo.id" value="${personInfo.id}">
	<table class="posttable">
		...
		<tr>
			...
			<td><label>现住地址：</label><ehr:tip><ehr:dic dicmeta="FS990001" code="${personInfo.patownShip }"></ehr:dic> <ehr:dic dicmeta="FS990001" code="${personInfo.pastreet }"></ehr:dic><ehr:dic dicmeta="FS990001" code="${personInfo.paGroup }"></ehr:dic> ${personInfo.pahouseNumber }</ehr:tip></td>
