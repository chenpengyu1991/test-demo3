        ...
        <form id="searchForm">
            <table id="searchTable">
                ...
                <tr>
                    ...
                    <td class="col-text">采血日期</td>
                    <td class="col-input">
                        <input type="text" class="layui-input x-admin-sm-date" name="dontime" id="dontime"
                               style="width: 180px;padding-left: 0px;">
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td class="col-text">制备日期</td>
                    <td class="col-input">
                        <input type="text" class="layui-input x-admin-sm-date" name="proctime" id="proctime"
                               style="width: 180px;padding-left: 0px;">
                    </td>
                    <td class="col-text">失效日期</td>
                    <td class="col-input">
                        <input type="text" class="layui-input x-admin-sm-date" name="exptime" id="exptime"
                               style="width: 180px;padding-left: 0px;">
                    </td>
                     <td class="col-text">区域</td>
                    <td class="col-input">
                        <input type="text" name="branch" style="width:180px;">
                    </td>
