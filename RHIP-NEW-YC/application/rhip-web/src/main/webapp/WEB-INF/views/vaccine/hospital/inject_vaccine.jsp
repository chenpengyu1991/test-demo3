		...
		<table style="width:99%" class="posttable">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<tag:autoSelect name="vaccineCompanyCode" id="vaccineCompanyCode" nameValue="辽宁成大生物股份有限公司" codeValue="4" style="width:150px"  reg='{"required":"true","maxlength":"33"}'></tag:autoSelect>
