...
<c:forEach items="${brwDiseaseInfo.tumorReports}" var="reportInfo">
	<table class="posttable">
		...
		<tr>
			...
			<td><ehr:dic dicmeta="DMD00010"
					code="${reportInfo.tumorDiagnosisDepends}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><fmt:formatDate value="${reportInfo.tumorAccidentDate}"
					pattern="yyyy/MM/dd" /></td>
			<th><label>诊断日期</label></th>
			<td><fmt:formatDate value="${reportInfo.tumorDiagnosisDate}"
					pattern="yyyy/MM/dd" /></td>
		</tr>
	</table>
	<hr />
