...
<%--<div class="toolbar">--%>
	<%--<c:if test="${isShowBackBtn}">--%>
		<%--<a href="javascript:void(0)" id="pFPBackViewId"><b class="fanhui">返回</b></a>--%>
	<%--</c:if>--%>
<%--</div>--%>
<div style="background-color: white; height: 1180px;">
	<ul>
	...
	<div class="table-basic">
		<table>
			...
			<tr>
				<th>尿常规</th>
				<td colspan="3">
					尿蛋白:<ehr:dic code="${prenatalFollowup.urineProQuantitativeValue}" dicmeta="CV0450015"/>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					其它:${prenatalFollowup.otherAuxiliaryExamination}
				</td>
			</tr>
			<tr>
				<th>血型</th>
			...
			<tr>
				<th>乙型肝炎表面抗原</th>
				<td>
					<ehr:dic code="${prenatalFollowup.hbsagDetectResult}" dicmeta="CV0450015"/>
				</td>
				<th>乙型肝炎表面抗体</th>
				<td>
					<ehr:dic code="${prenatalFollowup.hbsDetectResult}" dicmeta="CV0450015"/>
				</td>
			</tr>
			<tr>
				<th>乙型肝炎e抗原</th>
				<td>
					<ehr:dic code="${prenatalFollowup.hbeagDetectResult}" dicmeta="CV0450015"/>
				</td>
				<th>乙型肝炎e抗体</th>
				<td>
					<ehr:dic code="${prenatalFollowup.hbeDetectResult}" dicmeta="CV0450015"/>
				</td>
			</tr>
			<tr>
				<th>梅毒血清学试验结果</th>
			...
			<tr>
				...
				<th>是否转诊</th>
				<td>
					<ehr:dic code="${prenatalFollowup.referralFlag}" dicmeta="FS10111"/>
				</td>
			</tr>
			<c:if test="${prenatalFollowup.referralFlag eq '2'}">
				<tr id="referralFlagId">
					<th>机构及科室</th>
					<td>
						<input reg='{"maxlength":16}' type="text" name="referralHospitalName" value="${prenatalFollowup.referralHospitalName}" style="width: 20%"/>
						<input reg='{"maxlength":16}' type="text" name="referralDeptName" value="${prenatalFollowup.referralDeptName}" style="width: 20%"/>
					</td>
					<th>转诊原因</th>
					<td>
						<input reg='{"maxlength":16}' type="text" name="referralReason" value="${prenatalFollowup.referralReason}" style="width: 30%"/>
					</td>
				</tr>
			</c:if>
			<tr>
