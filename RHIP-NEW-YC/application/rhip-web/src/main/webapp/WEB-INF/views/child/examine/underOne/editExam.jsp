...
<script src="${pageContext.request.contextPath}/js/views/ehr/child/examine/underOne/editExam.js" type="text/javascript"></script>
...
<div class="toolbar">
    ...
    <a href="javascript:void(0)" id="saveChildExamBtn">
...
<div class="postcontent divFixed125" style="top: 260px">
    ...
    <div class="postdiv">
        <form method="post" id="childExaminationForm">
            ...
            <input type="hidden" name="idCard" value="${exam.idCard}">
            ...
            <i class="popno">1-8月龄儿童健康检查记录表</i>
            <table class="posttable">
                <tr>
                    <th style="width:15%">月龄</th>
                    <td style="width:35%">
                        <select id="cPhysicalExamAge" name="cPhysicalExamAge">
                            <option value="满月" ${"满月" eq examAge ? 'selected' : ''}>满月</option>
                            <option value="3月龄" ${"3月龄" eq examAge ? 'selected' : ''}>3月龄</option>
                            <option value="6月龄" ${"6月龄" eq examAge ? 'selected' : ''}>6月龄</option>
                            <option value="8月龄" ${"8月龄" eq examAge ? 'selected' : ''}>8月龄</option>
                        </select>
                    </td>
