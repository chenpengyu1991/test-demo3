...
<input type="hidden" id="openPath" value="${pageContext.request.contextPath}/external/report/main?${parameters}"/>
...
<div class="toolbar" style="margin-top: 10px;margin-right: 25px">
    ...
    <c:if test="${from eq 'csws'}">
        ...
        <a href="javascript:void(0)" id="report-input-save-btn"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe605;</i>提交</button></a>
    </c:if>
</div>
        ...
        $(function () {
            ...
            if('csws' != from){
                ...
                layui.use('layer', function(){
					...
					layer.confirm(confirmMsg,{icon:0, title:'确认提示'},function(r){
						if(r){
	                        $("#fdm-report-card-main").show();
	                        setResult(false);
	                    }else{
