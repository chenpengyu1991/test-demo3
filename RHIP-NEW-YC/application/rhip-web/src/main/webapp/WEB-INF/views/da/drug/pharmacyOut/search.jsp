...
<script src="${pageContext.request.contextPath}/js/views/da/drug/pharmacyOut/search.js" type="text/javascript"></script>
...
<div class="section" id="top_all">
	<div class="searchbox searchSection x-admin-sm">
		...
		<form id="pharmacyOutSearchForm">
			<table id="pharmacyOutSearch" >
				<colgroup>
				...
				<tbody>
					<tr>
						...
						<td class="righttd" rowspan="2">
							<button class="layui-btn layui-btn-sm" id="pharmacyOutBtnSearch"><i class="layui-icon">&#xe615;</i>查询</button>
						</td>
					</tr>
					<tr>
						<td class="coltext">出库类别</td>
						<td class="colinput">
							<ehr:dic-list  name="deliveryTypeCode" dicmeta="DA00010" value="" width="200px"/>
						</td>
			...
			<table>
				<tr>
					<td colspan="6" class="colbottom">
						  <span onclick="daCommon.toggle(this,'pharmacyOutSearch')" class="ico-bottom">&nbsp;</span>
					</td>
				</tr>
			</table>
		 </form>
	</div>
	<div id="pharmacyOutResultDiv"></div>
</div>
<div id="pharmacyOutDetailDiv"></div>
...
<script type="text/javascript">
	layui.use('laydate', function(){
		...
		//执行一个laydate实例
		laydate.render({
			elem: '#pharmacyOutSearchForm #beginDt'
			,format: 'yyyy/MM/dd'
			,max:0
		});
		...
		//执行一个laydate实例
		laydate.render({
			elem: '#pharmacyOutSearchForm #endDt'
			,format: 'yyyy/MM/dd'
			,max:0
		});
	});
