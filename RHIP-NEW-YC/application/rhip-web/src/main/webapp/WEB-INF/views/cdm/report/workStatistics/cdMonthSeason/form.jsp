...
<tbody>
	<tr>
		...
		<input type="text" class="layui-input x-admin-sm-date" style="width:80px;padding-left: 0px;" placeholder="选择月份" name="yearMonth" id="cdMonthSeasonYearMonthId" value="<fmt:formatDate value='${currentDate}' pattern='yyyy/MM'/>" />
		</td>
		...
		<button class="layui-btn layui-btn-sm" id="cdm-month-statistics-search"><i class="layui-icon">&#xe615;</i>查询</button>
		</td>
	</tr>
</tbody>
