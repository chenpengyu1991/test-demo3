		...
		<tbody>
			<c:forEach var="detail" items="${details}" varStatus="status">
				<tr>
                    ...
                    <td class="centertd"><tags:numberLabel value="${detail.quantitySum}" fractionDigits="2"/></td>
                    <td class="centertd"><tags:numberLabel value="${detail.costSum}" fractionDigits="2"/></td>
