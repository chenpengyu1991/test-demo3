...
<script src="${pageContext.request.contextPath}/js/views/ihm/healthCardTarget/cwhOrg.js" type="text/javascript"></script>
<div class="toolbar">
    <div class="x-nav">
...
<div class="section">
        ...
        <form id="targetSearchForm">
            <table id="targetSearch">
                <colgroup>
                    ...
                    <col style="width: 40%; min-width: 45px;"/>
                ...
                <tr>
                    ...
                    <td class="col-input">
                        ...
                        <div id="byMonth">
                            <input type="text" class="layui-input x-admin-sm-date"  name="monthDate" id="beginDate1" style="width:33%;" value="">
                        </div>
                        <div id="byQuarter">
                            <input type="text" class="layui-input x-admin-sm-date"  name="quarterDate" id="beginDate2" style="width:33%;">
                            <select name="rangeQuarter" id="rangeQuarter" style="width: 180px;">
    ...
    <div id="resultDiv">
        <jsp:include page="statisticSummary.jsp"/>
    </div>
</div>
