    ...
    <table style="width: 100%;" class="layui-table x-admin-sm-table-list-middle">
        ...
        <c:forEach var="report" items="${summaryList}" varStatus="status">
            <tr>
                ...
                <td class="centertd"><tags:numberLabel value="${report.BXBNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.BXBUPNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.BXBDOWNNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.BXBP*100}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.HXBNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.HXBUPNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.HXBDOWNNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.HXBP*100}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.XXBNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.XXBUPNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.XXBDOWNNUM}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.XXBP*100}" defaultValue="0" align="center"/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
