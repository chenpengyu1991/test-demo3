        ...
        <fieldset class="layui-elem-field">
			...
			<table style="width:99%" class="posttable">
				...
				<tbody>
					...
					<tr>
	                    <th>接种部位：</th>
	                    <td><ehr:dic dicmeta="FS990031" code="${vaccineRecord.immuPosition}" /></td>
	                    <th>接种途径：</th>
	                    <td><ehr:dic dicmeta="FS990032" code="${vaccineRecord.vaccineWay}"></ehr:dic></td>
						<th>是否收费：</th>
						<td><ehr:dic dicmeta="PH00001" code="${vaccineRecord.feeFlag}"></ehr:dic></td>
					</tr>		
				</tbody>
			</table>
			</c:if>
