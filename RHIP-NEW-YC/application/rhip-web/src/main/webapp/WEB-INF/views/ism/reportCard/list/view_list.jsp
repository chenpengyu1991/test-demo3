	...
	<div class="toolbar">
		...
		<div class="searchbox" style="width: 100%" >
			<form method="post" id="form_search">
				<input type="hidden" id="ism-view-flag" value="${reportFlag}"/>
				...
				<colgroup>
					...
					<tbody>
						...
						<td class="coltext" >上报时间</td>
							...
							<td class="colinput"><ehr:dic-list id="dm-report-status" width="200" dicmeta="DMD00005" name="reportStatus"  uninclude="6,7,8,9,10,11"/></td>
						</tr>
					<tr>
						<td class="coltext">
							<ehr:authorize ifAnyGranted="11">上报机构 </ehr:authorize>
						</td>
						<td class="colinput">
