...
<div  class="section" id="list_view">
	<div class="toolbar">
        ...
        <a href="javascript:void(0)" id="reportcard-list-export-btn"><button class="layui-btn layui-btn-sm button" ><i class="layui-icon">&#xe67d;</i>导出</button></a>
    </div>
				...
				<colgroup>
					...
					<tbody>
						...
						<td class="coltext" >上报时间</td>
							...
							<td class="colinput">
								<tag:numberInput maxlength="3"  style="width:38%;"  name="startAge" id="startAge" cssClass="x-layui-input" /> ~ 
								<tag:numberInput maxlength="3"  style="width:38%;"   name="endAge" id="endAge" cssClass="x-layui-input" /> 岁
							</td>
					...
					<tr>
						...
						<td class="colinput"><ehr:dic-list id="dm-report-status"   dicmeta="DMD00005" name="reportStatus" cssClass="x-layui-input"/></td>
						<td class="coltext">
							<ehr:authorize ifAnyGranted="01,0107">上报机构</ehr:authorize>
						</td>
						<td class="colinput">
							<ehr:authorize ifAnyGranted="01,0107">
								<ehr:org-type-list id="createOrganCode" name="reportCreateOrganCode" type="hospital,centre,station" cssClass="x-layui-input"/>
							</ehr:authorize>
						</td>
						<td></td>
						<td align="left">
