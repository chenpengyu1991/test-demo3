        ...
        <form id="searchForm">
            <table id="searchTable">
                ...
                <tr>
                    ...
                    <td class="col-input">
                        <div class="layui-form"><ehr:dic-list name="gender" dicmeta="GBT226112003"/></div>
                    </td>
                    <td class="col-text">出生日期</td>
                    <td class="col-input">
                        <input type="text" class="layui-input x-admin-content-sm-date" name="birthday" id="birthday" />
                    </td>
                </tr>
                <tr>
                    <td class="col-text">体检机构</td>
                    <td class="col-input">
                    ...
                    <td class="col-input">
                        <input type="text" class="layui-input x-admin-content-sm-date" name="createDate" id="createDate" />
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    layui.use('laydate', function(){
        var laydate = layui.laydate;/child/statistics/childCount
