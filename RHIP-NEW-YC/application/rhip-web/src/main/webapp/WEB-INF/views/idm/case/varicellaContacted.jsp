...
<div>
		...
		<div>
			<table class="formtable" id="popEfcTable">
				<tr>
					...
					<th style="width: 15%"><label class="required">密切接触者姓名</label></th>
				...
				<tr>
					<th>是否患过水痘</th>
					<td><ehr:dic-radio name="attackCondition" dicmeta="PH00002" code="1,2" value="${idmListEfc.attackCondition}"/></td>
					<th>是否接种过水痘疫苗</th>
					<td><ehr:dic-radio name="vaccineHistory" dicmeta="PH00002" code="1,2" value="${idmListEfc.vaccineHistory}" /></td>
				</tr>
				<tr>
					<th>接触方式</th>
    ...
    <div class="toolbarpop">
        <c:if test="${type == 'add'}">
            <input type="button" id="saveContactPerson" value="添加" onclick="varicellaCase.addEfcList()">
        </c:if>
        <c:if test="${type == 'edit'}">
            <input type="button" id="editContactPerson" value="修改" onclick="varicellaCase.editEfcList()">
        </c:if>
