...
<table class="posttable">
	...
	<tr>
		...
		<td><textarea id="condition" name="condition" reg="{'required':true,'maxlength':33}">${strtum.condition}</textarea></td>
	</tr>
	<tr>
		<th><label class="required" for="treatment">治疗（常规）</label></th>
		<td><textarea id="treatment" name="treatment" reg="{'required':true,'maxlength':33}">${strtum.treatment}</textarea></td>
	</tr>
</table>
