 ...
 */
@Controller
@RequestMapping(value = "/vaccinationCensus")
public class VaccinationCensusController  extends VisitController{
	...
	public String search(HttpServletRequest request, ModelMap model) {
		...
		return "rhip.phsr.vaccinationCensus.search";
	}
	...
	public String list(HttpServletRequest request, ModelMap model) {
		...
		if(SecurityUtils.hasRole(RoleType.ZXJKDN, request) || SecurityUtils.hasRole(RoleType.ZJKDN, request)) {
		...
		return "rhip.phsr.vaccinationCensus.list";
	}
	@ResponseBody
