...
//		遍历class1Bean，获取逐个属性值，然后遍历class2Bean查找是否有相同的属性，如有相同则赋值
	...
	public static void main(String args[]){
		ElderlyPhyExamination ss = new ElderlyPhyExamination();
		ss.setAge("11");
		ss.setArteriopalmus("222");
		PhysiqueExamination jj=new PhysiqueExamination();
		try {
			reflectionAttr(ss,jj);
			System.out.println(jj.getAge());
			System.out.println(jj.getArteriopalmus());
			System.out.println(jj.getAbdominalMassDesc());
		} catch (Exception e) {
