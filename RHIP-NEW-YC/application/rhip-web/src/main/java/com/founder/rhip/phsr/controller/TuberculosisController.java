...
@Controller
@RequestMapping(value = "/tuberculosis")
public class TuberculosisController extends VisitController{
	...
	public String search(HttpServletRequest request, ModelMap model) {
		...
		return "rhip.phsr.he.tuberculosis.search";
	}
	...
	public String list(HttpServletRequest request, ModelMap model) {
		...
		return "rhip.phsr.he.tuberculosis.list";
	}
	
	@ResponseBody
	@RequestMapping("/saveTuberculosis")
	public String saveTuberculosis(HttpServletRequest request, ModelMap model) {
