 ...
 */
public class RHIPAbstractTicketValidationFilter extends RHIPAbstractCasFilter {
     ...
     * string.
     */
    private boolean redirectAfterValidation = true; //default false; modify by yaofeng
    ...
    /**
     * Gets the configured {@link javax.net.ssl.HostnameVerifier} to use for HTTPS connections
