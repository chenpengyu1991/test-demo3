...
import com.founder.rhip.ehr.dto.ErrorResult;
	...
	*/
	...
	public static void saveDataFile(String dataXml, String dataType,String folder) {
		if (ObjectUtil.isNotEmpty(folder)) {
			StringBuilder sb = new StringBuilder(folder).append(dataType).append(File.separator).append(DateUtil.toDateString(new Date(), "yyyyMMdd")).append(File.separator);
