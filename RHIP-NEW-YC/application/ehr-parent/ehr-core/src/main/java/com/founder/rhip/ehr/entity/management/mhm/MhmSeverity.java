...
@Entity
@Table(name = "MHM_SEVERITY")
public class MhmSeverity implements Serializable {
	...
	@Column(name = "STATUS", columnDefinition = "VARCHAR2|病人类型（1重性，2非重性）|2|", length = 2, nullable = true)
