...
@Entity
@Table(name = "MHM_DRUG_FREE")
public class MhmDrugFree implements Serializable {
	...
	@Column(name = "STATUS", columnDefinition = "VARCHAR2|状态（1是免费，0不是免费）|2|", length = 2, nullable = true)
