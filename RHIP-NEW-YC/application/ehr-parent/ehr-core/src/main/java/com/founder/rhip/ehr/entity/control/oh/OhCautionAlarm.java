...
@Entity
@Table(name = "OH_CAUTION_ALARM")
public class OhCautionAlarm implements Serializable {
	...
	@Column(name = "NAME", columnDefinition = "VARCHAR2|警示标示、报警仪名称|50|", length = 50, nullable = true)
	private String name;

	@Column(name = "TYPE", columnDefinition = "VARCHAR2|类别|2|", length = 2, nullable = true)
	private String type;

	@Column(name = "CAUTION", columnDefinition = "VARCHAR2|安装位置|2|", length = 2, nullable = true)
	private String caution;

	@Column(name = "COUNT", columnDefinition = "VARCHAR2|数量|2|", length = 2, nullable = true)
