...
@Entity
@Table(name = "IDM_LIST_LC")
public class ListLc implements Serializable {
	...
	@Column(name = "RECOMMEND_TYPE", columnDefinition = "VARCHAR2|推荐方法|2|", length = 2, nullable = true)
	private String recommendType;

	@Column(name = "MIND_EVALUATE", columnDefinition = "VARCHAR2|照料评价|2|", length = 2, nullable = true)
	private String mindEvaluate;

	@Column(name = "EXISTING_PROBLEM", columnDefinition = "VARCHAR2|存在问题|200|", length = 200, nullable = true)
	private String existingProblem;

	@Column(name = "SUGGEST", columnDefinition = "VARCHAR2|建议|200|", length = 200, nullable = true)
	...
	public String getMindEvaluate() {
		return this.mindEvaluate;
	}

	public void setMindEvaluate(String mindEvaluate) {
		this.mindEvaluate = mindEvaluate;
	}
