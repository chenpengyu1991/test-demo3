...
@Entity
@Table(name = "DA_CONSUMABLE_OUT_DETAIL")
public class ConsumableOutDetail implements Serializable {
	...
	@Column(name = "APPLY_PRICE", columnDefinition = "NUMBER|入库单价（进货价格）||", scale = 10, precision = 2, nullable = true)
	...
	@Column(name = "APPLY_AMOUNT", columnDefinition = "NUMBER|出库金额（入库单价×实发数量）||",scale = 10, precision = 2, nullable = true)
