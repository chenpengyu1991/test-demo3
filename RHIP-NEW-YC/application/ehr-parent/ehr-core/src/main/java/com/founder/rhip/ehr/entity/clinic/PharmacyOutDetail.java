...
@Entity
@Table(name = "DA_PHARMACY_OUT_DETAIL")
public class PharmacyOutDetail implements Serializable {
	...
	@Column(name = "APPLY_PRICE", columnDefinition = "NUMBER|请领单价（出库价格）||",scale = 10, precision = 2, nullable = true)
	private BigDecimal applyPrice;

	@Column(name = "APPLY_NUM", columnDefinition = "NUMBER|请领数量||",scale = 10, precision = 2, nullable = true)
	private BigDecimal applyNum;

	@Column(name = "APPLY_REAL_NUM", columnDefinition = "NUMBER|实发数量||",scale = 10, precision = 2, nullable = true)
	private BigDecimal applyRealNum;

	@Column(name = "APPLY_AMOUNT", columnDefinition = "NUMBER|出库金额（请领单价×实发数量）||",scale = 10, precision = 2, nullable = true)
	...
	public BigDecimal getApplyRealNum() {
		return this.applyRealNum;
	}

	public void setApplyRealNum(BigDecimal applyRealNum) {
		this.applyRealNum = applyRealNum;
	}
