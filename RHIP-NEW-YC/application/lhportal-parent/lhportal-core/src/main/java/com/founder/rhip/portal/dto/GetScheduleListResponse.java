...
public class GetScheduleListResponse implements Serializable{
	...
	private PageActionOut pageactionout;
	...
	public PageActionOut getPageactionout() {
		return pageactionout;
	}

	public void setPageactionout(PageActionOut pageactionout) {
		this.pageactionout = pageactionout;
	}
