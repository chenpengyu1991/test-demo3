...
@Entity
@Table(name="RD_INCOME")
public class RdIncome implements Serializable {
	...
	@Column(name="MEDICAL_INCOME",columnDefinition="NUMBER|医疗收入||",length=12,scale=12,precision=2,nullable=true)
	private BigDecimal medicalIncome;

	@Column(name="DRUG_INCOME",columnDefinition="NUMBER|药品收入||",length=12,scale=12,precision=2,nullable=true)
	private BigDecimal drugIncome;

	@Column(name="INSPECTION_INCOME",columnDefinition="NUMBER|检查检验收入||",length=12,scale=12,precision=2,nullable=true)
	private BigDecimal inspectionIncome;

	@Column(name="CONSUMABLES_INCOME",columnDefinition="NUMBER|医用耗材收入||",length=12,scale=12,precision=2,nullable=true)
	private BigDecimal consumablesIncome;

	@Column(name="OTHER_INCOME",columnDefinition="NUMBER|其它收入||",length=12,scale=12,precision=2,nullable=true)
	private BigDecimal otherIncome;

	@Column(name="TOTAL_INCOME",columnDefinition="NUMBER|合计收入||",length=12,scale=12,precision=2,nullable=true)
	...
	public BigDecimal getInspectionIncome() {
		return this.inspectionIncome;
	}

	public void setInspectionIncome(BigDecimal inspectionIncome) {
		this.inspectionIncome = inspectionIncome;
	}

	public BigDecimal getConsumablesIncome() {
		return this.consumablesIncome;
	}

	public void setConsumablesIncome(BigDecimal consumablesIncome) {
		this.consumablesIncome = consumablesIncome;
	}
