        ...
        <tr>
            <c:choose>
             ...
             <c:choose>
                ...
                <c:otherwise>
                	<th rowspan="2">住院死亡数</th>
		            <th rowspan="2">自动出院数</th>
		            <th rowspan="2">住院手术数</th>
		            <th rowspan="2">手术死亡数</th>
		            <th rowspan="2">危重抢救数</th>
		            <th rowspan="2">危重死亡数</th>
		            <th rowspan="2">新生儿死亡率%</th>
                </c:otherwise>
            </c:choose>
        </tr>
    ...
    <table style="width: 100%;">
        ...
        <c:forEach var="report" items="${results}" varStatus="status">
            <tr>
                ...
                <td class="centertd"><tags:numberLabel value="${report.inhospitalDeathNum}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.autoLeaveNum}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.inhospitalSurgeryNum}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.operativeDeathNum}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.criticalRescueNum}" defaultValue="0" align="center"/></td>
                <td class="centertd"><tags:numberLabel value="${report.criticalDeathNum}" defaultValue="0" align="center"/></td>
                <td class="centertd">
                	<c:choose>
                		<c:when test="${report.newbornNum == 0}">0</c:when>
                		<c:otherwise>
                			<tags:numberLabel value="${report.criticalDeathNum/report.newbornNum}" defaultValue="0" align="center" fractionDigits="2"/>
                		</c:otherwise>
                	</c:choose>
                </td>
            </tr>
