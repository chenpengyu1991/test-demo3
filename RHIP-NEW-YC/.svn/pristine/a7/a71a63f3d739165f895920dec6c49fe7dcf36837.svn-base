...
<script type="text/javascript">
    require(['views/ihm/realNameAnalysTarget/trend'],function(trendIndex){
        trendIndex.load();
    });
</script>
<div class="section" id="top_all">
    <div class="searchBox">
        <form id="trendSearchForm">
            <table id="trendSearch">
                <colgroup>
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <input type="button" id="trendBtnSearch" value="查询" onclick="" class="search_btn" />
                    </td>
                </tr>
            ...
            <table>
                <tr>
                    <td class="col-bottom">
                        <span onclick="util.toggle(this,'trendSearch')" class="ico-bottom">&nbsp;</span>
                    </td>
                </tr>
            </table>
    ...
    <div id="trendChartDiv" style="height:450px;padding:10px 20px 10px 20px;">
