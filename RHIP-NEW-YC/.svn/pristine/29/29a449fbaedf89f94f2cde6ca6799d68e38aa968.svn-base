...
<script src="${pageContext.request.contextPath}/js/views/phsr/childStatistical/search.js" type="text/javascript"></script>
...
<div class="section">
					...
					<tbody>
						<tr>
							...
							<td class="col-input" colspan="3">
								<input type="radio" id="mhmReprtYearId" name="countType"  class="radioGroup" value="1" checked="checked" onclick="childStatisticalSearch.changeReportType()"/><label for="mhmReprtYearId">按年</label>
                       		 	<input type="radio" id="mhmReprtQuarterId" name="countType"  class="radioGroup" value="2" onclick="childStatisticalSearch.changeReportType()"/><label for="mhmReprtQuarterId">按季度</label>
				...
				<table>
					<tr>
						<td colspan="4" class="colbottom"><span
							onclick="childStatisticalSearch.toggle(this,'childStatisticalSearch')"
		...
		<div class="toolbarSection">
			<!-- <a id="childStatisticalResultDivExport" href="javascript:void(0)"><b class="export">导出</b></a> -->
