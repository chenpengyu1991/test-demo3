var saveHepatitisPage = (function(){
	var validate=null;
	//点击保存按钮
	$(function(){
		$.Placeholder.init({
		...
		validate = $("#vaccine_hepatitis_save").easyValidate();
		$("#hepatitisSave").click(function(e){
            e.preventDefault();
			vaccineSave();
		});

        $("#hepatitisBack").click(function() {
	...
	function vaccineSave(){
		...
		$("#vaccine_hepatitis_save").submitFormLoadHtml({
			 url : "/ph/hepatitis/save",
	...
	function getPatientInfo() {
		...
		$("#vaccine_hepatitis_save").submitFormGetJson({
