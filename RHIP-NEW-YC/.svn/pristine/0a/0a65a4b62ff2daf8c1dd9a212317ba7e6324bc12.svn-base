...
@Entity
@Table(name = "DA_DRUG_UPKEEP")
public class DrugUpkeep implements Serializable {
	...
	@Column(name = "BATCH_NO", columnDefinition = "VARCHAR2|养护单号（批次号）|50|", length = 50, nullable = true)
	private String batchNo;

	@Column(name = "UPKEEP_DT", columnDefinition = "DATE|养护日期||", nullable = true)
	private Date upkeepDt;

	@Column(name = "ORGAN_CODE", columnDefinition = "VARCHAR2|医疗机构编码|50|", length = 50, nullable = true)
	private String organCode;

	@Column(name = "ORGAN_NAME", columnDefinition = "VARCHAR2|医疗机构名称|100|", length = 100, nullable = true)
	private String organName;

	@Column(name = "UPKEEP_DEPARTMENT_CODE", columnDefinition = "VARCHAR2|科室编码|50|", length = 50, nullable = true)
	private String upkeepDepartmentCode;

	@Column(name = "UPKEEP_DEPARTMENT_NAME", columnDefinition = "VARCHAR2|科室名称|100|", length = 100, nullable = true)
	private String upkeepDepartmentName;

	@Column(name = "STORAGE_LOCATION", columnDefinition = "VARCHAR2|库位|50|", length = 50, nullable = true)
	private String storageLocation;

	@Column(name = "DRUG_TYPE_CODE", columnDefinition = "VARCHAR2|药品分类编码（药品分类字典）|50|", length = 50, nullable = true)
	private String drugTypeCode;

	@Column(name = "DRUG_TYPE_NAME", columnDefinition = "VARCHAR2|药品分类|100|", length = 100, nullable = true)
	...
	@Column(name = "UPKEEP_NUM", columnDefinition = "NUMBER|药品数量||",scale = 10, precision = 2,nullable = true)
	private BigDecimal upkeepNum;
	...
	@Column(name = "DAMAGE_ELEMENT_CODE", columnDefinition = "VARCHAR2|损坏因素类别编码（1次品；2伪劣；3破损；4霉变；5其他）|1|", length = 1, nullable = true)
	private String damageElementCode;

	@Column(name = "DAMAGE_ELEMENT_OTHER", columnDefinition = "VARCHAR2|损坏因素类别其他|50|", length = 50, nullable = true)
	private String damageElementOther;

	@Column(name = "OPERATOR_CODE", columnDefinition = "VARCHAR2|养护人员编码|50|", length = 50, nullable = true)
	private String operatorCode;

	@Column(name = "OPERATOR_NAME", columnDefinition = "VARCHAR2|养护人员名称|50|", length = 50, nullable = true)
	...
	public Date getUpkeepDt() {
		return this.upkeepDt;
	}

	public void setUpkeepDt(Date upkeepDt) {
		this.upkeepDt = upkeepDt;
	}
	...
	public String getUpkeepDepartmentCode() {
		return this.upkeepDepartmentCode;
	}

	public void setUpkeepDepartmentCode(String upkeepDepartmentCode) {
		this.upkeepDepartmentCode = upkeepDepartmentCode;
	}

	public String getUpkeepDepartmentName() {
		return this.upkeepDepartmentName;
	}

	public void setUpkeepDepartmentName(String upkeepDepartmentName) {
		this.upkeepDepartmentName = upkeepDepartmentName;
	}
	...
	public BigDecimal getUpkeepNum() {
		return this.upkeepNum;
	}

	public void setUpkeepNum(BigDecimal upkeepNum) {
	...
	public String getDamageElementOther() {
		return this.damageElementOther;
	}

	public void setDamageElementOther(String damageElementOther) {
		this.damageElementOther = damageElementOther;
	}
