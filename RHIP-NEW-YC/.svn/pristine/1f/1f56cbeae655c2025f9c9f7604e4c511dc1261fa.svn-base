...
<script src="${pageContext.request.contextPath}/js/views/da/daily/inpatientDrug/drugSearch.js" type="text/javascript"></script>
<div class="toolbar">
               ...
               <table>
                <tr>
                    <td colspan="6" class="colbottom">
                          <span onclick="daCommon.toggle(this,'drugSearch')" class="ico-bottom">&nbsp;</span>
                    </td>
                </tr>
			</table>
		 </form>
