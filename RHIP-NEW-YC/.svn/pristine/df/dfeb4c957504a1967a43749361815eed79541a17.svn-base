...
public class StartupListener implements ServletContextListener
{
    ...
    public void contextInitialized(ServletContextEvent event)
    {
        ...
        Map<String, Object> config = (HashMap<String, Object>) context.getAttribute(CoreConstants.CONFIG);
        ...
        if (context.getInitParameter(CoreConstants.CSS_THEME) != null)
        {
            config.put(CoreConstants.CSS_THEME,
                    context.getInitParameter(CoreConstants.CSS_THEME));
        }
        ...
        context.setAttribute(CoreConstants.CONFIG, config);
