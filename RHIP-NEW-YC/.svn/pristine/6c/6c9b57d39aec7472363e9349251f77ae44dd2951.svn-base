...
<script src="${pageContext.request.contextPath}/js/views/da/drug/pharmacyOut/detailSearch.js" type="text/javascript"></script>
<div class="toolbar">
	<button href="javascript:void(0)" onclick="pharmacyOutSearch.returnSearch()" class="btn-gray layui-btn layui-btn-sm button" onclick=""><i class="layui-icon"></i>返回</button>
</div>
