 ...
 * calls are read-only, instead of structural changes. Read calls are
 * non-synchronized and write calls perform the following steps:
 * </p>
 * <ul>
...
public final class FastHashMap implements Map, Serializable {
	 ...
	 * Fields .....
	 */
	private static final long serialVersionUID = -8852965805057110902L;
