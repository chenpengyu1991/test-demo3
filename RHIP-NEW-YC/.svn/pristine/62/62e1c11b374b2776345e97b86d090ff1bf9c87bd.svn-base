...
@XmlRootElement
public class WomenChildHealthNew implements Serializable{
    ...
    @Column(name = "ORG_NAME", columnDefinition = "VARCHAR2|填报机构名称||", length = 70, nullable = true)
    private String orgName;
    
    @Item(index=3,column ="性别")
    ...
    @Item(index=4,column ="出生日期",isDate=true,datePattern="yyyy/MM/dd")
    ...
    @Item(index=5,column ="年龄")
    @Column(name = "AGE", columnDefinition = "VARCHAR2|年龄", length = 100, nullable = true)
    private String age;
    @Item(index=6,column ="母亲姓名")
    @Column(name = "MOTHER_NAME", columnDefinition = "VARCHAR2|母亲姓名", length = 100, nullable = true)
	...
	@Item(index=11,column ="常住类型",isDic=true,dicType="FS10005")
	@Transient
	private String householdType;

	@Item(index=12,column ="户籍地址-县(区)",isDic=true,dicType="FS990001")
	@Transient
	private String hrcounty;

	@Item(index=13,isDic=true,dicType="FS990001",column ="户籍地址-乡镇")
	@Transient
	private String hrtownShip;

	@Item(index=14,isDic=true,dicType="FS990001",column ="户籍地址-村")
	@Transient
	private String hrstreet;

	@Item(index=15,column ="户籍地址详细")
	@Transient
	private String hrhouseNumber;

	@Item(index=7,column ="现住址-县(区)",isDic=true,dicType="FS990001")
	@Transient
