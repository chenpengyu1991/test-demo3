...
<script src="${pageContext.request.contextPath}/js/views/da/consumable/in/detailSearch.js" type="text/javascript"></script>
<div class="toolbar">
	<a href="javascript:void(0)" onclick="consumableInSearch.returnSearch()"><button class="btn-gray layui-btn layui-btn-sm button"><i class="layui-icon">&#xe65c;</i>返回</button></a>
</div>
