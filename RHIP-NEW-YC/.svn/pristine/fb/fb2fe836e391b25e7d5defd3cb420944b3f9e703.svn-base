...
<div class="repeattable">
	<table class="layui-table x-admin-sm-table-list-middle">
		...
		<tbody>
			<c:forEach var="detail" items="${pharmacyCancelDetails}" varStatus="status">
				<tr>
                    ...
                    <td><tags:numberLabel value="${detail.CANCEL_NUM}" fractionDigits="2"/></td>
                    <td><tags:numberLabel value="${detail.CANCEL_PRICE}" fractionDigits="2"/></td>
                    <td><tags:numberLabel value="${detail.CANCEL_AMOUNT}" fractionDigits="2"/></td>
