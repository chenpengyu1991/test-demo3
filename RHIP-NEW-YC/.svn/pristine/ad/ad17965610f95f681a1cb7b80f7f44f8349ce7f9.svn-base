...
public class Organization implements Serializable, Cloneable{
	...
	@Column(name = "PARENT_CODE", columnDefinition = "VARCHAR2|若上级机构编码为疾控||", length = 20, nullable = true)
	...
	@Column(name = "BED_COUNT", columnDefinition = "VARCHAR2|核准床位数||", nullable = true)
	private Integer bedCount;

	@Column(name = "OPEN_BED_COUNT", columnDefinition = "VARCHAR2|开放床位数||", nullable = true)
	...
	@Column(name = "EQUIPMENT_NUM", columnDefinition = "NUMBER|专业设备数-10万以下|", length = 4, nullable = true)
	private Integer equipmentNum;

	@Column(name = "EQUIPMENT_NUM_ONE", columnDefinition = "NUMBER|专业设备数-10万以上50万以下|", length = 4, nullable = true)
	private Integer equipmentNumOne;

	@Column(name = "EQUIPMENT_NUM_TWO", columnDefinition = "NUMBER|专业设备数-50万以上|", length = 4, nullable = true)
	private Integer equipmentNumTwo;
	...
	@Column(name = "SUBSID", columnDefinition = "NUMBER|子机构标识：0非子机构，1子机构||" , nullable = true)
	private Integer subsid;

	@Column(name = "DIRECTLY_FLAG", columnDefinition = "VARCHAR2|标识机构是否是直属 0不是，1是||" , nullable = true)
	private String directlyFlag;

	@Column(name = "SORT", columnDefinition = "NUMBER|排序|", length = 4, nullable = true)
	private Integer sort;

	@Column(name = "PARENT_CODE_HEALTH", columnDefinition = "VARCHAR2|若上级机构编码为医卫中心||", length = 20, nullable = true)
	private String parentCodeHealth;
	...
	public Organization clone(){
		Organization orgClone = null;
		try{
			orgClone = (Organization)super.clone();
	...
	public Integer getEquipmentNumOne() {
		return equipmentNumOne;
	}

	public void setEquipmentNumOne(Integer equipmentNumOne) {
		this.equipmentNumOne = equipmentNumOne;
	}

	public Integer getEquipmentNumTwo() {
		return equipmentNumTwo;
	}

	public void setEquipmentNumTwo(Integer equipmentNumTwo) {
		this.equipmentNumTwo = equipmentNumTwo;
	}

	public String getDirectlyFlag() {
		return directlyFlag;
	}

	public void setDirectlyFlag(String directlyFlag) {
	...
	public String getParentCodeHealth() {
		return parentCodeHealth;
	}

	public void setParentCodeHealth(String parentCodeHealth) {
		this.parentCodeHealth = parentCodeHealth;
	}
}