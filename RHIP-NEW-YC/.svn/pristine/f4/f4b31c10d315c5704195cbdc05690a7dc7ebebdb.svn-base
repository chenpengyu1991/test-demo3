...
<div>
<div class="toolbar">
    <a href="javascript:void(0)" onclick="javascript:filStandard.returnSearch('standardization.searchTemp')"><button class="btn-gray layui-btn layui-btn-sm button"><i class="layui-icon">&#xe65c;</i>返回</button></a>
    <c:if test="${logoff != '1'}">
        <a href="javascript:void(0)" onclick="javascript:filStandard.initAddSc()" id="xinzeng" style="display: none"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe608;</i>新增</button></a>
        <%--<a href="javascript:void(0)" onclick="javascript:filStandard.saveSc('edit')" id="xiugai" style="display: none"><b class="xiug">修改</b></a>--%>
        <a href="javascript:void(0)" onclick="javascript:filStandard.saveSc('edit')" id="xiugai" style="display: none"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe605;</i>保存</button></a>
        <a href="javascript:void(0)" onclick="javascript:filStandard.saveSc('add')" id="baocun" ><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe605;</i>保存</button></a>
    </c:if>
    <%--<a href="javascript:void(0)" onclick="javascript:contact.deleteCc()" id="shanchu" style="display: none"><b class="zuofei">删除</b></a>--%>
</div>
<div class="repeattable" id="scList" style="width:300px; float: left;margin-right: 10px;margin-top: 10px; margin-left: 10px;">
        ...
        <form id="scForm">
            ...
            <table id="scDetailDiv" class="posttable">
                ...
                <tr>
                    <th>2.上述评价的理由是：</th>
                    <td colspan="3">
                        <textarea name="reasonContent" id="reasonContent" rows="3" reg='{"maxlength":"800"}'>${listSc.reasonContent}</textarea>
                    </td>
                </tr>
                <tr>
                    <th>评价和整改意见：</th>
