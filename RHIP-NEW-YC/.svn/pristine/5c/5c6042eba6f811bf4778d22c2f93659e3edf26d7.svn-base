...
<div class="rightnav">
	<table>
		<tr>
	      	<td class="crumbs"><div id="location" parentMenu="women-health" childMenu="bornDefect">当前位置:&gt;&gt;妇女保健&gt;&gt;新生儿缺陷检测</div>
			</td>
	  	</tr>
	 </table>
<div style="background-color: white;">
	<ul>
		<li style="text-align: center;font-size: 25px;"><br>江苏省出生缺陷儿报告卡</li>
	</ul>
	<br>
	<div style="text-align: right;">
		填报日期：<fmt:formatDate value="${birthDefectMonitor.fillDate}" pattern="yyyy/MM/dd"></fmt:formatDate> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		编号：${birthDefectMonitor.recordNumber}&nbsp;&nbsp;&nbsp;&nbsp;
	</div>
	...
	<table>
		...
		<tr>
			...
			<c:if test='${birthDefectMonitor.familyKinMarriageFlag eq "1"}'>
				<th>家族近亲婚配者与本人关系</th>
				<td colspan="3">
					<ehr:dic dicmeta="GBT4761"  code="${birthDefectMonitor.familyKinMarriageRelation}"></ehr:dic>
				</td>
			</c:if>
		</tr>
	</table>
	...
	<div style="text-align: right;">
		填报人：${birthDefectMonitor.fillUserName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		填报单位：${birthDefectMonitor.fillUnitName}&nbsp;&nbsp;&nbsp;&nbsp;
	</div>
</div>
</div>