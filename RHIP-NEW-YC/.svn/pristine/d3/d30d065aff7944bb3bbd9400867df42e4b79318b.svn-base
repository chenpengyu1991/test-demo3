...
<div class="dm-followup-from-content">
                ...
                <fieldset class="layui-elem-field">
                    ...
                    <table class="posttable">
						<colgroup>
							...
							<input type="text" class="layui-input x-admin-content-sm-date" reg="{'required':true}" placeholder="选择时间" name="visitDate" id="strokeVisitDateId" value="<fmt:formatDate value='${strtum.visitDate}' pattern='yyyy/MM/dd'/>" style="padding-left: 0px;width:178px;" />
							</td>
						</tr>
						<tr>
    ...
    <jsp:include page="normalPrint.jsp"></jsp:include>
</div>
...
layui.use('laydate', function(){
    ...
    laydate.render({
      elem: '#strokeVisitDateId' 
   	   ,format: 'yyyy/MM/dd'
   	   ,max:0
   	 ,done:function(value) {
	        if(!$.isEmpty(value)){
	            $("#strokeVisitDateId").removeClass("lose");
	        }else{
	            $("#strokeVisitDateId").addClass("lose");
	        }
	   }
    });
