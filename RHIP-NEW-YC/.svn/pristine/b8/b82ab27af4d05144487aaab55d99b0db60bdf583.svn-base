...
<script src="${pageContext.request.contextPath}/js/views/mdm/administrative/adminOrgIndex.js" type="text/javascript"></script>
<div  class="sectionnoborder" style="margin-top: 10px;">
	...
	<div class="layui-tab layui-tab-brief" lay-filter="administrativeTab">
