 ...
 * @author Gavin King
 */
public class PropertyValueException extends BaseException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5282744347790891022L;
    ...
    public String getMessage() {
		return super.getMessage() + ": " +
			StringUtil.qualify(entityName, propertyName);
	}
