		...
		<table class="posttable">
			...
			<tr>
                    ...
                    <tr>
						...
						<td><tag:dateInput reg='{"required":"true"}' style="width: 150px;" name="guidanceTime" id="guidanceTime" date="${heIndividual.guidanceTime}" onlypast="true" /></td>
			</tr>
			<tr>
			...
			<tr>
						...
						<td>
							<ehr:org code="${heIndividual.orgCode }"></ehr:org>
						</td>
						</tr>
			<tr>
			<tr>
