...
<script src="${pageContext.request.contextPath}/js/views/phsr/mentalEpilepsyPatient/search.js" type="text/javascript"></script>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="col-input" colspan="4">
                        <input type="radio" id="YearType" name="countType"  class="radioGroup" value="1" checked="checked" onclick="mentalEpilepsyPatient.changeReportType()"/><label for="YearType">按年</label>
                        <input type="radio" id="QuarterType" name="countType"  class="radioGroup" value="2" onclick="mentalEpilepsyPatient.changeReportType()"/><label for="QuarterType">按季度</label>
                ...
                <tr>
                    ...
                    <td style="text-align: right;"><input type="button" id="mentalEpiSearch" value="查询" class="search_btn" /></td>
                </tr>
                </tbody>
            </table>
        </form>
    </div>
    <div id="mentalEpilepsyPatientListDiv">
    </div>
</div>
