...
<a href="javascript:void(0)" id="reportHelp"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe607;</i>帮助</button></a>
    <c:choose>
     	<c:when test="${approvalFlag==1}">
            <%-- <a href="javascript:void(0)" id="fanhui"><b class="fanhui">返回</b></a> --%>
            <%-- <a href="javascript:void(0)" id="tongguo1"><b class="tongguo">通过</b></a> --%>
            <a href="javascript:void(0)" id="tongguo1"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe605;</i>通过</button></a>
            <%-- <a href="javascript:void(0)" id="zuofei"><b class="zuofei">作废</b></a> --%>
            <a href="javascript:void(0)" id="zuofei"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#x1006;</i>作废</button></a>
            <!-- <a href="javascript:void(0)" id="jilu"><b class="jilu">操作记录</b></a> -->
            <a href="javascript:void(0)" id="jilu"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe60e;</i>操作记录</button></a>
            <a href="javascript:void(0)" id="fanhui"><button class="layui-btn btn-gray layui-btn-sm"><i class="layui-icon">&#xe65c;</i>返回</button></a>
        </c:when>
       <%--  <c:when test="${reportFlag=='reportOut'}">
            <input type="hidden" id="orgFlag" value="${orgFlag}">
            <a href="javascript:void(0)" onclick="javascript:reportEdit.diagnosisErrorExternal()"><b class="quxiao">诊断错误</b></a>
            <a href="javascript:void(0)" onclick="javascript:reportEdit.reportSubmitExternal()"><b class="tijiao">保存提交</b></a>
        ...
        <c:when test="${editFlag==1}">
            <%-- <a href="javascript:void(0)" id="fanhui"><b class="fanhui">返回</b></a> --%>
            <%-- <a href="javascript:void(0)" id="tongguo4"><b class="tongguo">保存</b></a> --%>
            <a href="javascript:void(0)" id="tongguo4"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe605;</i>保存</button></a>
            <%-- <a href="javascript:void(0)" id="zuofei"><b class="zuofei">作废</b></a> --%>
            <a href="javascript:void(0)" id="zuofei"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#x1006;</i>作废</button></a>
            <%-- <a href="javascript:void(0)" id="jilu"><b class="jilu">操作记录</b></a> --%>
            <a href="javascript:void(0)" id="jilu"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe60e;</i>操作记录</button></a>
        ...
        <c:otherwise>
            <%-- <a href="javascript:void(0)"  id="tijiao"><b class="tijiao">保存提交</b></a> --%>
            <a href="javascript:void(0)"  id="tijiao"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe605;</i>保存提交</button></a>
        </c:otherwise>
    </c:choose>
...
<input type="hidden" id="logoff" name="logoff" value="${reportDto.logoff}">
    <div class="postcontent contentfixed32 searchSection x-admin-sm">
        <i class="popno">中华人民共和国传染病报告卡 </i>
        <div style="text-align: center; color : red; font-size:14px;">${warning}</div>
        <div class="postdiv">
                <table class="posttable">
                    ...
                    <tr>
                        <td style="width: 50%; text-align: left;">
                            ...
                            <input type="hidden" id="reportIdmId" name="report.idmId" value="${reportDto.report.idmId}"/>
                            <input type="hidden" id="reportStatusId" name="report.reportStatus" value="${reportDto.report.reportStatus}"/>
                        	<input type="hidden" id="reportSource" name="report.reportSource" value="${reportDto.report.reportSource}"> 
                        	<input type="hidden" id="currentFillTimeS" name="report.currentFillTimeS" value="${reportDto.report.currentFillTimeS}"> 	
                        	<input type="hidden" id="currentDiagnosisTimeS" name="report.currentDiagnosisTimeS" value="${reportDto.report.currentDiagnosisTimeS}"> 		
                        </td>
                ...
                <table class="posttable">
                    ...
                    <%-- <tr>
						...
						<td style="text-align: left">
						    <ehr:dic-list id="otherIdcardType" name="report.otherIdcardType" value="${reportDto.report.otherIdcardType}" dicmeta="PH00034" defaultval= "0" onchange="reportEdit.idcardTypeChange(this.value);" ></ehr:dic-list>
						</td>
					</tr>
					<tr>
							 ...
							 <c:choose>
							    ...
							    <c:otherwise>
									<input type="text" id="idCard" name="report.idcard"  value="${reportDto.report.idcard}"
							        	placeholder="输入证件号获取个人信息" reg='{"idCard":"true"}'/>
							    </c:otherwise>
							</c:choose>
                        </td>
                    </tr> --%>
                    ...
                    <tr id="otherIdcardTypeDiv1">
                        ...
                        <td>
							 <c:choose>
							    ...
							    <c:otherwise>
									<input type="text" id="idCard" name="report.idcard" value="${reportDto.report.idcard}"
							        	placeholder="输入身份证获取个人信息" reg='{"idCard":"true"}'/><input type="button" id="check-submit-btn" value="读卡" style="width: 40px;">
							    </c:otherwise>
							</c:choose>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input type="text" id="age"  style="width: 50px;" name="report.age" value="${reportDto.report.age}" reg='{"digits":"true","min":"1","max":"200"}' onchange="reportEdit.occupationCheckAge()"/>
                            <span>年龄单位:</span>
                            <ehr:dic-radio id="ageUnit" name="report.ageUnit"  dicmeta="IDM00003" value="${reportDto.report.ageUnit}" onchange="reportEdit.occupationCheckAge()"/>
                            <span>）</span></td>
                    </tr>
                    <tr>
                        <th>工作单位或学校或托幼机构</th>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                        	<ehr:dic-radio name="report.infectedpersonBelong" dicmeta="CV0201104" id="infectedpersonBelongId" uninclude="7"
                                          ...
                                          reg='{"required":"true"}' onchange="reportEdit.toggerAddress()"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input type="text" class="layui-input x-admin-content-sm-date" reg='{"required":"true"}' name="report.pathogenesisDate" id="pathogenesisDateId" style="width: 100px;padding-left: 0px;" value="<fmt:formatDate value='${reportDto.report.pathogenesisDate}' pattern='yyyy/MM/dd'/>"/>
                    ...
                    <tr>
                        ...
                        <td>
                        	<%-- <tag:dateInput nullToToday="true" id="diagnosisDateId" name="report.diagnosisDate" pattern="yyyy/MM/dd HH:mm:ss"
                            	date="${reportDto.report.diagnosisDate}" onlypast="true" reg='{"required":"true","compare":["pathogenesisDateId","ge","诊断日期不能早于发病日期"]}' style="width: 140px"></tag:dateInput> --%>
                            <input type="text" class="layui-input x-admin-content-sm-date" reg='{"required":"true","compare":["pathogenesisDateId","ge","诊断日期不能早于发病日期"]}' name="report.diagnosisDate" id="diagnosisDateId" style="width: 140px;padding-left: 0px;" value="<fmt:formatDate value='${reportDto.report.diagnosisDate}' pattern='yyyy/MM/dd HH:mm:ss'/>"/>
                    ...
                    <tr>
                        <th>死亡日期</th>
                        <td>
                        <%-- <tag:dateInput id="deathDateId" name="report.deathDate" pattern="yyyy/MM/dd HH"
                                           date="${reportDto.report.deathDate}" onlypast="true" reg='{"compare":["pathogenesisDateId","ge","死亡日期不能早于发病日期"]}'
                                           style="width: 100px"></tag:dateInput>时 --%>
            ...
            <fieldset class="topfield layui-elem-field" style="border-top: none;">
                <table class="posttable">
                    <colgroup>
                        <col style="min-width: 80px; width: 20%;"/>
                        <col style="min-width: 150px; width: 30%;"/>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <select name="report.infectiousCode" id="infectiousCode"
                                    reg='{"required":"true"}' onchange="reportEdit.infectiousChange(this.value);">
                            </select>
                    ...
                    <tbody id="2032detail" style="display: none">
                        <tr>
                            ...
                            <th>首次出现乙肝症状和体征时间</th>
                            <td>
                            <tag:dateInput id="hbvSignDtID" name="reportDesc.hbvSignDt" date="${reportDto.reportDesc.hbvSignDt}" pattern="yyyy/MM"/>
                    ...
                    <tbody id="206detail" style="display: none">
                        ...
                        <tr id="hospitalDt_id" style="display: none">
                            <th><label class="required">住院日期</label></th>
                            <td>
                            <%-- <tag:dateInput name="reportDesc.inHospitalDt" pattern="yyyy/MM/dd" date="${reportDto.reportDesc.inHospitalDt}" onlypast="true"/> --%>
                            ...
                            <th>出院日期</th>
                            <td>
                            <%-- <tag:dateInput name="reportDesc.outHospitalDt" pattern="yyyy/MM/dd" date="${reportDto.reportDesc.outHospitalDt}" onlypast="true"/> --%>
                    ...
                    <tbody id="222223detail" style="display: none">
                        ...
                        <tr>
                            ...
                            <td>
                                <ehr:dic-list id="educationId" name="report.education" dicmeta="GBT46582006" value="${reportDto.report.education}"
                                               code="IDM11,IDM12,IDM04,IDM13,IDM03,IDM02,IDM07,90" width="150px"/>
                            </td>
                            <!-- <th></th>
                            <td></td> -->
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <ehr:dic-town-street-village villageId="hrvillage_address" townId="hrtown_address" callback="reportEdit.displayHrAddress"
                                                      villageName="report.hrGroup" townName="report.hrtownShip"
                                                      streetId="hrstreet_address" streetName="report.hrstreet" streetValue="${reportDto.report.hrstreet}"
                                                      villageValue="${reportDto.report.hrGroup}" townValue="${reportDto.report.hrtownShip}" width="180px;"
                                />
                                
                                </div>
                                <label id="tempHrValue">
                                    <ehr:dic code="${reportDto.report.hrtownShip}" dicmeta="FS990001"/>
                                    <ehr:dic code="${reportDto.report.hrstreet}" dicmeta="FS990001"/>
                                    <ehr:dic code="${reportDto.report.hrGroup}" dicmeta="FS990001"/>
                                </label>
                        ...
                        <tr>
                            ...
                            <td><ehr:dic-list id="infectionWayId" name="reportDesc.infectionWay" dicmeta="IDM00339" value="${reportDto.reportDesc.infectionWay}" width="150px"/></td>
                        </tr>
                        <tr>
                            <th><label class="required" re = 1>样本来源</label></th>
                            <td><ehr:dic-list id="sampleSourceId" name="reportDesc.sampleSource" dicmeta="IDM00340" value="${reportDto.reportDesc.sampleSource}" width="150px"/></td>
                ...
                <table class="posttable">
                    ...
                    <tr>
                        ...
                        <td><tag:dateInput nullToToday="true" name="report.fillDate" pattern="yyyy/MM/dd"
                                           date="${reportDto.report.fillDate}" onlypast="true" reg='{"required":"true","compare":["pathogenesisDateId","ge","填卡日期不能早于发病日期"]}'
                                           style="width: 80px">
                        </tag:dateInput>
                        </td> --%>
                         <th><label class="required">填卡日期</label></th>
                        <td>
                        	<%-- <tag:dateInput nullToToday="true" id="fillDateId" name="report.fillDate" pattern="yyyy/MM/dd HH:mm:ss"
                            	date="${reportDto.report.fillDate}" onlypast="true" reg='{"required":"true","compare":["diagnosisDateId","ge","填卡日期不能早于诊断日期"]}' style="width: 140px"></tag:dateInput> --%>
            ...
            <fieldset class="topfield layui-elem-field" style="display: none;border-top: none;" id="deleteContentId">
                <table class="posttable">
                    ...
                    <tr>
                        <th>作废原因:</th>
                        <td colspan="3">
                            <ehr:dic-radio name="report.deleteContent" dicmeta="IDM00379" value="${reportDto.report.deleteContent}" onchange="toggleOther('report.deleteContent','deleteContentOtherId','99');"/>
    ...
    layui.use('laydate', function() {
        ...
        laydate.render({
            elem: '#pathogenesisDateId'
              ...
              ,done:function (value) {
            if(!$.isEmpty(value)){
                $("#pathogenesisDateId").removeClass("lose");
            }else{
                $("#pathogenesisDateId").addClass("lose");
            }
        }
          });
