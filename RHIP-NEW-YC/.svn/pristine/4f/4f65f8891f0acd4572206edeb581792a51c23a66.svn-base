...
<script src="${pageContext.request.contextPath}/js/views/da/equipment/store/search.js" type="text/javascript"></script>
					...
					<tbody>
						<tr>
                            ...
                            <td class="righttd" rowspan="2">
                                <input type="button" id="storageBtnSearch" value="查询" class="search_btn"/>
                            </td>  							                         
						</tr>
						<tr>
