...
<script src="${pageContext.request.contextPath}/js/views/mhm/followup/search.js" type="text/javascript"></script>
...
<c:set var="ZJSB" value="<%=RoleType.ZJSB.getValue()%>"/>
	<div class="section" id="followup_top_all">
	<div class="toolbar">
	 	<div class="x-nav">
		...
		<div class="searchbox searchSection x-admin-sm">
			...
			<form id="followupSearchForm">
                <input type="hidden" name="searchSource" value="${searchSource}" id="searchSource">
					...
					<tbody>
						...
						<tr>
	                    	<td class="righttd" colspan="6">
                                <button class="layui-btn layui-btn-sm" id="searchFollowupButton"><i class="layui-icon">&#xe615;</i>查询</button>
                ...
                <c:if test="${searchSource eq '1'}">
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td class="collink">
                                <div id="jsws-followup-links">
                                    <a class="jsws-followup-link" href="javascript:void(0)" data-followupflag="1">30天内待访</a>
                                    <a class="jsws-followup-link" href="javascript:void(0)" data-followupflag="2">逾期待访</a>
                                </div>
                            </td>
                            <td></td>
                ...
                <table>
	                <tr>
	                    <td colspan="6" class="colbottom">
	                          <span onclick="mhmCommon.toggle(this,'followupSearch')" class="ico-bottom">&nbsp;</span>
	                    </td>
	                </tr>
				</table>
			 </form>
		...
		<div id="followupResultDiv"></div>
	</div>
	<div id="followupDetailDiv" ></div>
