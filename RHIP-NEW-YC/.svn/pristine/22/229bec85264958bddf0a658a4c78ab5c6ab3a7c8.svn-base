var healthVaccinationSearch = (function() {
	var validate = null;
	$(function() {
		$("#editBody").hide();
        showModifyButton();
		...
		validate = $("#healthVaccinationSearchForm").easyValidate();
        /*健康教育统计查询*/
        $("#healthVaccinationSearchForm").onEnter(search, 1);
        $("#healthVaccinationBtnSearch").click(function() {
            search();
        });
        search();
        ...
        $("#saveCommunityId").click(function () {
            ...
            $("#communityInfoForm").submitFormLoadHtml({
                url: contextPath + "/healthVaccination/saveVaccination",
                insertDiv: "healthVaccinationResultDiv",
                param: {
                    "year": year,
                    "month": month
                },
	...
	function search() {
		...
		var year = $("#healthVaccinationSearchForm #year").val();
		var month = $("#healthVaccinationSearchForm #month").val();
		var createBeginTime = new Date($("#healthVaccinationSearchForm #createBeginTime").val());
		var createEndTime = new Date($("#healthVaccinationSearchForm #createEndTime").val());
		...
		var searchObj = {
			url : "/healthVaccination/list",
			insertDiv : "healthVaccinationResultDiv"
		};
		$("#healthVaccinationSearchForm").submitFormLoadHtml(searchObj);
	}
...
$(document).ready(function () {
	...
	//按钮样式切换 
	$("#healthVaccinationBtnSearch").hover( 
	function () { 
