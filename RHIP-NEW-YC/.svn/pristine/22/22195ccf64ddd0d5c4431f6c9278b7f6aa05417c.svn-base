...
<div class="repeattable" style="overflow: auto">
	<table class="layui-table x-admin-sm-table-list-middle">
		<colgroup>
	        ...
	        <col style="min-width:100px;width: 10%;"/>
	        <col style="min-width:80px;width: 8%;"/>
			<col style="min-width:160px;width: 16%;"/>
			<col style="min-width:100px;width: 10%;"/>
		</colgroup>
		<thead>
			<tr>
		...
		<tbody>
			<c:forEach var="detail" items="${storageInDetails}" varStatus="status">
				<tr>
			...
			<tr>
				...
				<c:if test="${empty type}"><ehr:pagination action="detailSearch.search" colspan="14"/></c:if>
			</tr>
		</tbody>
	</table>
</div>