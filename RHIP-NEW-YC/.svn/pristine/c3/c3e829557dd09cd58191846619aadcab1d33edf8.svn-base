...
<div id="report" >
	...
	<input type="hidden" id="iden_index">
	<c:if test="${isInfo eq 1 }"><jsp:include page="personInfo.jsp"></jsp:include></c:if>
    <div class="toolbar" style="margin-top: 10px;">
        <c:if test='${sourceFlag eq "1"}'>
        <a href="javascript:void(0)" id="ech-phyexam-add-back-btn"><button class="btn-gray layui-btn layui-btn-sm button"><i class="layui-icon">&#xe65c;</i>返回</button></a>
        </c:if>
        <c:if test='${sourceFlag eq "1" || sourceFlag eq "2"}'><c:if test='${editflag == "edit"}'>
        <%-- <a href="javascript:void(0)" id="calcTZJG" ><b class="calculator">计算</b></a> --%>
        <a href="javascript:void(0)" id="calcTZJG" ><button class="layui-btn layui-btn-sm button"><i class="layui-icon">&#xe620;</i>计算</button></a>
        </c:if>
        </c:if>
        <c:if test='${editflag == "edit"}'>
            ...
            <a href="javascript:void(0)" id="qiQualityGuidance" onclick="document.getElementById('view').scrollIntoView();"><button class="layui-btn layui-btn-sm button"><i class="layui-icon">&#xe770;</i>指导</button></a>
        ...
        <a href="javascript:void(0)" id="button_printId" ><button class="layui-btn layui-btn-sm button"><i class="layui-icon">&#xe66d;</i>打印</button></a>
    </div>
    <input type="hidden" id="sourceFlag" value="${sourceFlag}"/><%--页面来源 1：中医药，2：健康档案 --%>
    <div class="postcontent" id="printDivId" style="width: auto;">
                ...
                <table class="posttable">
                    ...
                    <c:if test='${editflag == "edit"}'>
                        ...
                        <tr class="guidanceClass" >
                            ...
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(2)"><b>气虚质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(3)"><b>阳虚质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(4)"><b>阴虚质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(5)"><b>痰湿质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(6)"><b>湿热质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(7)"><b>血瘀质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(8)"><b>气郁质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(9)"><b>特禀质</b></a></th>
                            <th class="centerth"><a href="javascript:void(0)" onclick="javascript:echReport.printHealthEducation(1)"><b>平和质</b></a></th>
                        </tr>
                        <tr class="guidanceClass" >
                            <th class="centerth" style="padding-top: 75px;"> <b>中医药保健指导:</b></th>
                            <th class="leftth"><!-- 气虚质 --><input type="hidden" name="qiFlag" value="${report.qiFlag}"/>
                            ...
                            <th class="leftth"><!-- 阳虚质 --><input type="hidden" name="yangFlag" value="${report.yangFlag}"/>
                            ...
                            <th class="leftth"><!-- 阴虚质 --><input type="hidden" name="yinDeficiencyFlag" value="${report.yinDeficiencyFlag}"/>
                            ...
                            <th class="leftth"><!-- 痰湿质 --><input type="hidden" name="phlegmWetnessFlag" value="${report.phlegmWetnessFlag}"/>
                            ...
                            <th class="leftth"><!-- 湿热质 --><input type="hidden" name="heatMediumFlag" value="${report.heatMediumFlag}"/>
                            ...
                            <th class="leftth"><!-- 血瘀质 --><input type="hidden" name="bloodFlag" value="${report.bloodFlag}"/>
                            ...
                            <th class="leftth"><!-- 气郁质 --><input type="hidden" name="qiStagnationFlag" value="${report.qiStagnationFlag}"/>
                            ...
                            <th class="leftth"><!-- 特禀质 --><input type="hidden" name="specialFlag" value="${report.specialFlag}"/>
                            ...
                            <th class="leftth"><!-- 平和质 --><input type="hidden" name="peacefulFlag" value="${report.peacefulFlag}"/>
                        ...
                        <tr>
                            ...
                            <th class="leftth"><!-- 气虚质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.qiFlag eq '3' or report.qiFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="qiQualityGuidance" isBr="true" value="${report.qiQualityGuidance}"></ehr:dic-checkbox></b>
                                        </c:if>
                                        <c:if test="${report.qiFlag != '3' and report.qiFlag != '1'}">
                                            <ehr:dic-checkbox disabled="true" dicmeta="CHG10510" name="qiQualityGuidance" isBr="true" value="${report.qiQualityGuidance}"></ehr:dic-checkbox></b>
                                        </c:if>
                                    </div>
                                    <span class="qiQualityGuidanceDetail" style="display: none;">
                            ...
                            <th class="leftth"><!-- 阳虚质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.yangFlag eq '3' or report.yangFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="yangQualityGuidance" isBr="true" value="${report.yangQualityGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                                        <c:if test="${report.yangFlag != '3' and report.yangFlag != '1'}">
                                            <ehr:dic-checkbox  dicmeta="CHG10510" name="yangQualityGuidance" isBr="true" disabled="true" value="${report.yangQualityGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                            ...
                            <th class="leftth"><!-- 阴虚质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.yinDeficiencyFlag eq '3' or report.yinDeficiencyFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="yinDeficiencyGuidance" isBr="true" value="${report.yinDeficiencyGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                            ...
                            <th class="leftth"><!-- 痰湿质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.phlegmWetnessFlag eq '3' or report.phlegmWetnessFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="phlegmWetnessGuidance" isBr="true" value="${report.phlegmWetnessGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                                        <c:if test="${report.phlegmWetnessFlag != '3' and report.phlegmWetnessFlag != '1'}">
                                            <ehr:dic-checkbox  dicmeta="CHG10510" disabled="true" name="phlegmWetnessGuidance" isBr="true" value="${report.phlegmWetnessGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                            ...
                            <th class="leftth"><!-- 湿热质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.heatMediumFlag eq '3' or report.heatMediumFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="heatMediumGuidance" isBr="true" value="${report.heatMediumGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                                        <c:if test="${report.heatMediumFlag != '3'and report.heatMediumFlag != '1'}">
                                            <ehr:dic-checkbox disabled="true" dicmeta="CHG10510" name="heatMediumGuidance" isBr="true" value="${report.heatMediumGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                            ...
                            <th class="leftth"><!-- 血瘀质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.bloodFlag eq '3' or report.bloodFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="bloodQualityGuidance" isBr="true" value="${report.bloodQualityGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                                        <c:if test="${report.bloodFlag != '3' and report.bloodFlag != '1'}">
                                            <ehr:dic-checkbox disabled="true" dicmeta="CHG10510" name="bloodQualityGuidance" isBr="true" value="${report.bloodQualityGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                            ...
                            <th class="leftth"><!-- 气郁质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.qiStagnationFlag eq '3' or report.qiStagnationFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="qiStagnationGuidance" isBr="true" value="${report.qiStagnationGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                                        <c:if test="${report.qiStagnationFlag != '3' and report.qiStagnationFlag != '1'}">
                                            <ehr:dic-checkbox  dicmeta="CHG10510" name="qiStagnationGuidance" isBr="true" disabled="true" value="${report.qiStagnationGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                            ...
                            <th class="leftth"><!-- 特禀质 -->
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.specialFlag eq '3' or report.specialFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="specialQualityGuidance" isBr="true" value="${report.specialQualityGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                                ...
                                <div style="border-top: 1px solid #A9C3D0;">
                                    ...
                                    <div>
                                        <c:if test="${report.peacefulFlag eq '3' or report.peacefulFlag eq '1'}">
                                            <ehr:dic-checkbox onclick="this.checked=!this.checked" dicmeta="CHG10510" name="peacefulQualityGuidance" isBr="true" value="${report.peacefulQualityGuidance}"></ehr:dic-checkbox>
                                        </c:if>
                    ...
                    <tr><td colspan="10" ><hr style="margin:5px 0px 5px 5px;height:1px;color:#A9C3D0"/></tr>
                    <tr>
                        <th class="rightth" colspan="2"><span id="view">填表日期</span></th>
                        <td class="lefttd" colspan="4"><fmt:formatDate value="${report.createDate}" pattern="yyyy/MM/dd" /></td>
                        <th class="rightth" colspan="2">医生签名</th>
                        <td class="lefttd" colspan="4"><ehr:user userCode="${report.createUser}"></ehr:user></td>
                    </tr>
                    </tbody>
                </table>
            </form>
