...
import com.founder.rhip.whch.common.DataType;
...
public class XmlParserTest {
	...
	/*	JAXBContext context = JAXBContext.newInstance(BirthCertificate.class);
		...
		JAXBContext context = JAXBContext.newInstance(MotherhoodPeriodFollowup.class);
		Marshaller jaxbMarshaller = context.createMarshaller();
		// output pretty printed
		jaxbMarshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);
		MotherhoodPeriodFollowup motherhoodPeriodFollowup = new MotherhoodPeriodFollowup();
		//jaxbMarshaller.marshal(postpartumDaysHealthInfo, file);
		ByteArrayOutputStream bos = new ByteArrayOutputStream();
		jaxbMarshaller.marshal(motherhoodPeriodFollowup, bos);
