...
<fieldset class="layui-elem-field">
	...
	<fieldset class="layui-elem-field">
		<table class="posttable">
			...
			<tr style="${strtum.bpDrugFlag=='1'?'':'display:none'}">
			...
			<tr style="${strtum.bpDrugFlag=='2'?'':'display:none'}" >
				<th>未规律用药原因</th>
	...
	<fieldset class="layui-elem-field">
		<table class="posttable">
			...
			<tr style="${strtum.bgDrugFlag=='1'?'':'display:none'}" >
				<th><label>规律用药品种</label></th>
				<td>
					<table>
						<tr>
			...
			<tr style="${strtum.bgDrugFlag=='2'?'':'display:none'}"  >
				<th>未规律用药原因</th>
	...
	<fieldset class="layui-elem-field">
		<table class="posttable">
			...
			<tr style="${strtum.bfDrugFlag=='1'?'':'display:none'}" >
				<th><label>规律用药品种</label></th>
				<td>
					<table>
						<tr>
			...
			<tr style="${strtum.bfDrugFlag=='2'?'':'display:none'}" >
				<th>未规律用药原因</th>
