...
<div>
	<div id="top_allRecommendation">
		<div class="searchbox searchSection x-admin-sm">
			<form id="recommendationSearchForm">
				<table id="recommendationSearch">
					<colgroup>
					...
					<tbody>
						<tr>
							...
							<td class="colinput"><tag:idcardInput name="idcard" cssClass="x-layui-input"/></td>
						</tr>
						<tr>
							...
							<td class="colinput"><ehr:dic-list dicmeta="FS10005" name="floatPopulation"/></td>
                            <td class="righttd" colspan="2">
                            	<button class="layui-btn layui-btn-sm" id="recommendationBtnSearch"><i class="layui-icon">&#xe615;</i>查询</button>
                            </td>
						</tr>
					</tbody>
				</table>
				<table>
	                <tr>
	                    <td colspan="6" class="colbottom">
							<span onclick="tbCommon.toggle(this,'recommendationSearch')" class="ico-bottom">&nbsp;</span>
	                    </td>
	                </tr>
				</table>
			</form>
		...
		<div class="toolbarSection">
			<ehr:authorize ifNotGranted="${JKJHB}">
				<a href="javascript:void(0)" onclick="tbCommon.add('',${RECOMMENDATION},'1','Recommendation')"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe608;</i>新建</button></a>
			</ehr:authorize>
			<a href="javascript:void(0)" onclick="tbCommon.downLoadRecommendation()"><button class="layui-btn layui-btn-sm" ><i class="layui-icon">&#xe67d;</i>导出</button></a>
		</div>
		<div id="listDivRecommendation"></div>
	</div>
	<div id="detailDivRecommendation"></div>
</div>