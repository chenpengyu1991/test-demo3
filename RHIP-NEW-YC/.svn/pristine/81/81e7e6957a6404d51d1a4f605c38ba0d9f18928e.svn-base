...
<div class="toolbar">
    ...
    <a href="javascript:void(0);" id="modifySave"><button class="layui-btn layui-btn-sm button"><i class="layui-icon"></i>保存</button></a>
    
</div>
<div class="Contentbox divFixed105" style="text-align: left;top: 65px;">
    <form id="modifyPostnatalForm"  method="post">
        <ul>
            <li style="text-align: center; font-size: 25px;">产后访视记录表</li>
        </ul>
        <br/>
        <div class="postcontent">
            <input type="hidden" value="${postnatalFollowup.id}" name="id"/>
            <input type="hidden" value="${postnatalFollowup.personId}" name="personId"/>
            <input type="hidden" value="${postnatalFollowup.createOrganCode}" name="createOrganCode"/>
            <input type="hidden" value="${postnatalFollowup.createOrganName}" name="createOrganName"/>
            <table class="posttable">
                ...
                <tr>
                    ...
                    <td><input type="text" id="temperature" reg='{"required":"true"}' name="temperature" value="${postnatalFollowup.temperature}" />℃</td>
                </tr>
                <tr>
                    <th width="15%"><label class="required">一般健康情况</label></th>
                    <td><input type="text" id="healthStatus" reg='{"required":"true"}' name="healthStatus" value="${postnatalFollowup.healthStatus}" /></td>
                    <th width="15%"><label class="required">一般心理状况</label></th>
                    <td><input type="text" id="psychologicalStatus" reg='{"required":"true"}' name="psychologicalStatus" value="${postnatalFollowup.psychologicalStatus}" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <span id="referralReason" CLASS="hidediv"> &nbsp;&nbsp;&nbsp;&nbsp;机构及科室:<input reg='{"maxlength":"33"}' type="text" name="referralHospitalName" value="${postnatalFollowup.referralHospitalName}" style="width: 180px;">
                    <input reg='{"maxlength":"33"}' type="text" name="referralDeptName" value="${postnatalFollowup.referralDeptName}" style="width: 100px;">
                ...
                <td colspan="3">
                    ...
                    <%--<ehr:dic code="${postnatalFollowup.cmediciManageFlag}" dicmeta="FS10307"/>--%>
                ...
                <tr>
                    ...
                    <td><ehr:staff-list name="supervisionDoctor" reg='{"required":"true"}' defaultval="Y" value="${postnatalFollowup.supervisionDoctor}" style="width:75%"/></td>
                    <th><label class="required">产妇签字</label></th>
                    <td>
                        <input type="text" id="Maternalname" reg='{"required":"true"}' value="${postnatalFollowup.name}"/>
                    </td>
                </tr>
                <tr>
