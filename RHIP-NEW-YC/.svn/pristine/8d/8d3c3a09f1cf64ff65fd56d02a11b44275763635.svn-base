...
<div class="rightnav">
	<table>
		<tr>
	      	<td class="crumbs"><div id="location" parentMenu="child-care" childMenu="childHealthCard">当前位置:&gt;&gt;妇女保健&gt;&gt;儿童保健卡</div>
			</td>
	  	</tr>
	 </table>
<div style="background-color: white;">
	...
	<div class="table-basic">
		<table>
			...
			<tr>
				<th>出生孕周(周)</th>
				<td>${childHealthCard.gestationalWeeksWeek}</td>
				<th>出生孕周(天)</th>
				<td>${childHealthCard.gestationalWeeksDay}</td>
			</tr>
			<tr>
				<th>出生日期</th>
