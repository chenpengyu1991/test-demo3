...
<%--<script src="${pageContext.request.contextPath}/js/views/pam/person/performanceSearch.js" type="text/javascript"></script>--%>
<script src="${pageContext.request.contextPath}/js/views/ihm/cwhTarget/hmTree.js" type="text/javascript"></script>
