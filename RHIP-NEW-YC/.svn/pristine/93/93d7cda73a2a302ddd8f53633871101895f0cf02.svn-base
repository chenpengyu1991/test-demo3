...
<c:if test="${popPrintId!=1}">
    <div class="toolbar" style="margin-top: 10px;">
       <%--  <a href="javascript:void(0)" id="popPrintId1" onclick="javascript:reportPrint.returnSearch()"><b class="fanhui">返回</b></a> --%>
        <a href="javascript:void(0)" id="popPrintId1" onclick="javascript:reportPrint.returnSearch()"><button class="btn-gray layui-btn layui-btn-sm button" ><i class="layui-icon">&#xe65c;</i>返回</button></a>
        <%-- <a href="javascript:void(0)" id="popPrintId2"
         ...
         <a href="javascript:void(0)" id="popPrintId2"
           onclick="javascript:reportPrint.approvalDialog(${reportDto.report.idmId})"><button class="layui-btn layui-btn-sm" ><i class="layui-icon">&#xe60e;</i>操作记录</button></a>
        ...
        <c:choose>
            <c:when test="${printFlag==2}">
                ...
                <a href="javascript:void(0)" id="popPrintId3"
                   onclick="javascript:reportPrint.print(${reportDto.report.id})"><button class="layui-btn layui-btn-sm" ><i class="layui-icon">&#xe66d;</i>打印</button></a>  
            </c:when>
        </c:choose>
    </div>
</c:if>
...
<fieldset class="layui-elem-field">
    <table class="posttable">
        ...
        <tr>
            <th>死亡日期</th>
            <td>
                <fmt:formatDate value="${reportDto.report.deathDate}" pattern="yyyy/MM/dd hh"/>
            </td>
        </tr>
        </tbody>
    </table>
</fieldset>
<fieldset class="topfield layui-elem-field">
    <table class="posttable">
        <colgroup>
            <col style="min-width: 80px; width: 20%;"/>
            <col style="min-width: 150px; width: 30%;"/>
...
<fieldset class="topfield layui-elem-field">
    <table class="posttable">
        ...
        <tr>
            <th>报告医生</th>
            <td><ehr:user userCode="${reportDto.report.reportDoctorId}"/></td>
            <th>填卡日期</th>
            <td>
                <fmt:formatDate value="${reportDto.report.fillDate}" pattern="yyyy/MM/dd HH:mm:ss"/>
            </td>
        </tr>
        </tbody>
    </table>
</fieldset>
<fieldset class="topfield layui-elem-field" id="deleteContentId">
    <table class="posttable">
