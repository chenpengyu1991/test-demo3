...
<script type="text/javascript">
	 require(['views/uthealth/oht/search'],function(ohtSearch){
		 ohtSearch.load();
	 });
</script>
...
<div class="section">
 <div class="searchbox">
	<form id="ohtFormId" name="ohtForm" action="" method="post">
		<table id="useSearchTableId">
               <colgroup>
				...
				<tr>
					...
					<td class="colinput">
						<input type="button" id="ohtSearchBut" value="查 询" class="search_btn" />
					</td>
				</tr>
			</tbody>
		</table>
         <table>
              <tr>
                  <td colspan="4" class="colbottom">
                         <span id="ohtSearchSpanId" class="ico-bottom">&nbsp;</span>
                  </td>
              </tr>
         </table>
	</form>
