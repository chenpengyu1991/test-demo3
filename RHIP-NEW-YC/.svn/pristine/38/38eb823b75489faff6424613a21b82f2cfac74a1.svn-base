...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
 <script src="${pageContext.request.contextPath}/js/views/cdm/standardization/healthCard/rollback.js" type="text/javascript"></script>

<div>
	<div class="toolbar">
	 <%-- <a href="javascript:void(0)" id="save"><b class="baocun">撤销</b></a> --%>
	 <a href="javascript:void(0)" id="save"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe669;</i>撤销</button></a>
	</div>
