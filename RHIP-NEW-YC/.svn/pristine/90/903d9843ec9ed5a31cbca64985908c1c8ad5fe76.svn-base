...
<script src="${pageContext.request.contextPath}/js/views/dmbc/medicalInst/infectMonitorSearch.js" type="text/javascript"></script>
<div class="section" id="mainSearchDiv">
	<div id="top_all">
		...
		<div class="searchbox">
			<form id="infectMonitorSearchForm">
				<table id="infectMonitorSearch">
					<colgroup>
				...
				<table>
					<tr>
						<td class="colbottom">
							<span class="ico-bottom" onclick="toggle(this,'infectMonitorSearch')">&nbsp;</span>
						</td>
					</tr>
				</table>
			</form>
