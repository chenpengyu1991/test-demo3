...
<script src="${pageContext.request.contextPath}/js/views/dmbc/vertor/mouseMonitorSearch.js" type="text/javascript"></script>
			...
			<form id="mouseSearchForm">				
				...
				<colgroup>
                    ...
                    <tr>
	                    ...
	                    <td class="coltext">布夹地点</td>
	                    <td >
	                    	<input type="text" id="place" name="place" />
	                    </td>
	                    <td class="coltext">布夹环境</td>
	                    <td class="colinput">
	                        <ehr:dic-list name="environment" dicmeta="DMBC00001" width="150px;"/>   
	                    </td>
                        <td ></td>
                        <td align="left">
                            <input type="button" id="mouseBtnSearch" value="查询" class="search_btn"/>
                        </td>
                    </tr>
					</tbody>
				</table>
                <table>
	                <tr>
	                    <td colspan="6" class="colbottom">
	                          <span onclick="mouseMonitorSearch.toggle(this,'mouseSearch')" class="ico-bottom">&nbsp;</span>
	                    </td>
	                </tr>
				</table>
