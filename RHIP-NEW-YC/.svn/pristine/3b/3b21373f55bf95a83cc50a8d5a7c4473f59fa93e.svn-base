            ...
            <c:choose>
             ...
             <c:choose>
                ...
                <c:otherwise>
					...
					<th rowspan="2">人均处方数</th>
					<th rowspan="2">人均门急诊均次费用</th>
                </c:otherwise>
            </c:choose>
        </tr>
    ...
    <table style="width: 100%;">
        ...
        <c:forEach var="report" items="${result}" varStatus="status">
            <tr>
               ...
               <td data-is-data="true" data-total-level="0" data-total="${report.treatment_num}"><tags:numberLabel value="${report.treatment_num}" defaultValue="0" /></td>
                <td data-is-data="true" data-total-level="0" data-total="${report.prescription_numm}"><tags:numberLabel value="${report.prescription_numm}" defaultValue="0" /></td>
                <td data-is-data="true" data-total-level="0" data-total="${report.fee_total}"><tags:numberLabel value="${report.fee_total}" defaultValue="0" /></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
