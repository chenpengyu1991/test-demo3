      ...
      <table id="medicalGoodsSearch" >
          ...
          <tr>
           ...
           <td class="coltext">
            ...
            <td class="colinput">
             ...
             <td>
                 <input id="hospital_medical_search_btn1" class="search_btn" type="button" value="查询"/>
             </td>
          </tr>
        </tbody>
      </table>
       ...
       <tr>
           <td colspan="6" class="colbottom">
                 <span id="hospitalmedicalSearchToggle" class="ico-bottom">&nbsp;</span>
           </td>
       </tr>
	</table>
    </form>
