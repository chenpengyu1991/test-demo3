...
<script type="text/javascript">
	 require(['views/uthealth/ba/search'],function(baSearch){
		 baSearch.load();
	 });
</script>
...
<div class="section">
 <div class="searchbox">
	<form id="baFormId" name="baForm" action="" method="post">
		<table id="useSearchTableId">
               <colgroup>
				...
				<tr>
					...
					<td class="colinput">
						<input type="button" id="baSearchBut" value="查 询" class="search_btn" />
					</td>
				</tr>
			</tbody>
		</table>
         <table>
              <tr>
                  <td colspan="4" class="colbottom">
                         <span id="baSearchSpanId" class="ico-bottom">&nbsp;</span>
                  </td>
              </tr>
         </table>
	</form>
