...
<script src="${pageContext.request.contextPath}/js/views/ehr/child/examine/threeToSix/editExam.js" type="text/javascript"></script>
...
<div class="toolbar">
    ...
    <a href="javascript:void(0)" id="saveChildExamBtn"><button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe605;</i>保存</button></a>
</div>
<div class="postcontent divFixed125" style="top: 260px">
    ...
    <div class="postdiv">
        <form method="post" id="childExaminationForm">
            ...
            <i class="popno">3～6岁儿童健康检查记录表</i>
            <table class="posttable">
                <tr>
                    <th style="width:15%">月龄</th>
                    <td style="width:35%">
                        <select id="cPhysicalExamAge" name="cPhysicalExamAge">
                            <option value="3岁" ${"3岁" eq examAge ? 'selected' : ''}>3岁</option>
                            <option value="4岁" ${"4岁" eq examAge ? 'selected' : ''}>4岁</option>
                            <option value="5岁" ${"5岁" eq examAge ? 'selected' : ''}>5岁</option>
                            <option value="6岁" ${"6岁" eq examAge ? 'selected' : ''}>6岁</option>
                        </select>
                    </td>
