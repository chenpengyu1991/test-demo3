...
<script src="${pageContext.request.contextPath}/js/views/dmbc/vertor/roachMonitorSearch.js" type="text/javascript"></script>
<div class="section" id="mainSearchDiv">
	<div id="top_all">
		...
		<div class="searchbox">
			<form id="roachSearchForm">				
                <table id="roachSearch" >
				<colgroup>
					...
					<tbody>
						...
						<tr>
		                    ...
		                    <td class="colinput">
		                        <ehr:dic-list name="environment" dicmeta="DMBC00007" width="150px;"/>   
		                    </td>
		                    ...
		                    <td class="colinput">
							 ...
							 <td class="coltext"></td>
		                    <td align="left">
                            	<input type="button" id="roachBtnSearch" value="查询" class="search_btn"/>
                        	</td>
						</tr>
					</tbody>
				</table>
                <table>
	                <tr>
	                    <td colspan="6" class="colbottom">
	                          <span onclick="roachMonitorSearch.toggle(this,'roachSearch')" class="ico-bottom">&nbsp;</span>
	                    </td>
	                </tr>
				</table>
