...
<style>
    #strokePrintFollowUp .table-01{width:100%;height:10%; overflow:auto;clear:both;vertical-align:middle;}
    #strokePrintFollowUp .table-01{background:#FFF}
    #strokePrintFollowUp .table-01 table{width:100%; border-left:#C8BAAE solid 1px;border-top:#C8BAAE solid 1px;border-collapse:collapse;}
    #strokePrintFollowUp .table-01 td{text-align:left;height:24px;line-height:24px;border:1px solid #ccc;padding:2px;}
    #strokePrintFollowUp .table-01 th{border:1px solid #CCC;background:#EFF7FF;font-weight:normal;}
    #strokePrintFollowUp .table-01 td.td_gray{background:#EEE;}
    #strokePrintFollowUp .table-01 td.h_top{background:#66B9DB; font-weight:bold;text-align:center;color:#FFF;}
</style>

<div id="strokePrintFollowUp" style="display: none">
    <h3 align="center">脑卒中常规随访服务记录表</h3>
