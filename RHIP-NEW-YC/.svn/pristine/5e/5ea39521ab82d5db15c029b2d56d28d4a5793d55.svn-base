...
<script src="${pageContext.request.contextPath}/js/views/phsr/diCensus/search.js" type="text/javascript"></script>
					...
					<tbody>
						<tr>
							...
							<td class="col-input" colspan="3">
								<input type="radio" id="mhmReprtYearId" name="countType"  class="radioGroup" value="1" checked="checked" onclick="diCensus.changeReportType()"/><label for="mhmReprtYearId">按年</label>
                       		 	<input type="radio" id="mhmReprtQuarterId" name="countType"  class="radioGroup" value="2" onclick="diCensus.changeReportType()"/><label for="mhmReprtQuarterId">按季度</label>
                            ...
                            <td style="text-align: right;"><!-- <input type="button" id="diCensusBtnSearch" value="查询"
								 class="search_btn" /> -->
								 <button class="layui-btn layui-btn-sm" id="diCensusBtnSearch"><i class="layui-icon">&#xe615;</i>查询</button>
								 </td>
						</tr>
					</tbody>
				</table>
				<table>
					<tr>
						<td colspan="4" class="colbottom"><span
							onclick="diCensus.toggle(this,'diCensus')"
							class="ico-bottom">&nbsp;</span></td>
					</tr>
				</table>
			</form>
		</div>
		<div class="toolbarSection"><a id="diCensusResultDivExport" href="javascript:void(0)"><button class="layui-btn layui-btn-sm" ><i class="layui-icon">&#xe67d;</i>导出</button></a></div>
		<form id="communityInfoForm">
			<div id="diCensusResultDiv">
