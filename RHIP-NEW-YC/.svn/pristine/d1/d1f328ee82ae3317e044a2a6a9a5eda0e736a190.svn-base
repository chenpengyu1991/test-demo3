...
<div class="section">
	...
	<form id="roleFormId" name="roleForm" action="" method="post">
		<table class="formtable">
			...
			<tr>
				<th>权限设置</th>
				<td style="vertical-align: top; text-align: left;" colspan="3"><input type="button" style="width: 50px;" value="折 叠" onclick='collapseAll()' /> <input type="button" style="width: 50px;" value="展 开" onclick='expandAll()' />
					<ul id="tree1">
					</ul></td>
			</tr>
		</table>
		<div align="center">
			<input type="button" id="saveButtonId" name="save" value="保 存" onclick="saveRole()" class="btnopr" /> <input type="hidden" id="id" name="id" value="${role.id}" />
