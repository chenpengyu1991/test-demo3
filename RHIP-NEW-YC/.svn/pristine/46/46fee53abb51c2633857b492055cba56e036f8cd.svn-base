...
<script src="${pageContext.request.contextPath}/js/views/ncp/manageReport/search.js" type="text/javascript"></script>
    ...
    <div class="searchBox">
        <form id="manageReportForm">
            <table>
                ...
                <tbody>
                <tr>
                    <td class="col-text"><label>服务日期</label></td>
                    <td class="col-input" colspan="3">
                        <tag:dateInput name="serviceBeginDate" id="serviceBeginDate" onlypast="true" style="width: 40%;"/> ~
                        <tag:dateInput name="serviceEndDate" id="serviceEndDate" onlypast="true" style="width: 40%;"/>
                    </td>
                    <td class="col-text"><label>统计方式</label></td>
                    <td class="col-input">
                        <select id="selectMethod" name="selectMethod" style="width:150px;">
                            <option value="1">按医生</option>
                            <option value="2">按机构</option>
                        </select>
                    </td>
                </tr>
                <tr id="manageDoctorTr">
                    <td class="col-text"><label>责任医生</label></td>
                    <td class="col-input">
                        <input type="text" id="manageDoctor" name="manageDoctor"/>
                    </td>
                </tr>
                <tr>
