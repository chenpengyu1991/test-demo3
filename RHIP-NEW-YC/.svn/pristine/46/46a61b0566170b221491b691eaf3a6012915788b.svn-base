	...
	<div id="list_view">
		...
		<div class="toolbar" align="right">
			...
			<div class="searchbox searchSection x-admin-sm">	
				<form id="searchPreventiveInfo" name="" action="" method="post">
						...
						<tbody>				
						   <tr>
							...
							<tr>
								...
								<td></td><td></td><td></td>				
								<td class="colinput">
									<%-- <input type="button" id="searchPotentialPerson" value="查询" class="search_btn" > --%>
									<button class="layui-btn layui-btn-sm" id="searchPotentialPerson"><i class="layui-icon">&#xe615;</i>查询</button>
								</td>
								<td class="colinput">
									<input type="button" id="searchPotentialAndPerson" value="测试专用" style="display: none"  class="search_btn" >
								</td>
							</tr>
						</tbody>
					</table>
					<table>
		                <tr>
		                    <td colspan="6" class="colbottom">
		                          <span id ="preventiveManage" class="ico-bottom">&nbsp;</span>
		                    </td>
		                </tr>
					</table>
				</form>
			</div>
			<div id="preventiveManage_list"></div>
		</div>
	</div>
