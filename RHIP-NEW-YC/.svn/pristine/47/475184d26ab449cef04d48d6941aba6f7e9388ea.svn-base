		...
		<tbody>
			<c:forEach var="health" items="${healthlist}" varStatus="status">
				<tr>
					...
					<td class="centertd">
						<a title="查看门诊信息" class="layui-btn layui-btn-normal layui-btn-xs" href="javascript:void(0)" style="color: #FFF;font-size: 12px;" onclick="emrSearch.loadDetailDialog('/inpatient/detail/${health.id}', '出院信息','600','900')"><i class="layui-icon">&#xe615;</i>查看</a>
					</td>
				</tr>
			</c:forEach>
			<tr>
