...
<script src="${pageContext.request.contextPath}/js/views/phsr/doctorSignCensus/search.js" type="text/javascript"></script>
...
<div class="section">
		<div class="toolbar">
			<div class="x-nav">
		      <span class="layui-breadcrumb">
		        ...
		        <a>
		          <cite>家庭医生签约服务进展情况统计表</cite></a>
		      </span>
		</div>
		</div>
		<div class="searchBox searchSection x-admin-sm">
			<input type="hidden" name="timeFlag" value="1"/>
			<form id="doctorSignCensusSearchForm">
				<table id="doctorSignCensusSearch">
					<colgroup>
					...
					<tbody>
						<tr>
							...
							<td class="col-input" colspan="3">
								<input type="radio" id="mhmReprtYearId" name="countType"  class="radioGroup" value="1" checked="checked" onclick="doctorSignCensusSearch.changeReportType()"/><label for="mhmReprtYearId">按年</label>
                       		 	<input type="radio" id="mhmReprtQuarterId" name="countType"  class="radioGroup" value="2" onclick="doctorSignCensusSearch.changeReportType()"/><label for="mhmReprtQuarterId">按季度</label>
                            ...
                            <td style="text-align: right;"><!-- <input type="button" id="doctorSignCensusBtnSearch" value="查询"
								 class="search_btn" /> -->
								 <button class="layui-btn layui-btn-sm" id="doctorSignCensusBtnSearch"><i class="layui-icon">&#xe615;</i>查询</button>
								 </td>
						</tr>
					</tbody>
				</table>
				<table>
					<tr>
						<td colspan="4" class="colbottom"><span
							onclick="doctorSignCensusSearch.toggle(this,'doctorSignCensusSearch')"
	...
	<div class="toolbarSection">
		...
		<a id="doctorSignCensusResultDivExport" href="javascript:void(0)"><button class="layui-btn layui-btn-sm" ><i class="layui-icon">&#xe67d;</i>导出</button></a>
	</div>
		<form   id="communityInfoForm">
		<div id="doctorSignCensusResultDiv">
