    ...
    <div class="searchBox searchSection x-admin-sm">
        ...
        <form id="searchForm">
            <table id="searchTable">
                ...
                <tbody>
                <tr>
                    <td class="col-text">首次呼救电话</td>
                    <td class="col-input">
                        <input type="text" name="firstCall"  style="width: 180px;">
                    </td>
                    <td class="col-text">事件名称</td>
                    <td class="col-input">
                        <input type="text" name="eventTitle" style="width: 180px;" >
                    </td>
                    <td class="col-text">首次调度员</td>
                    <td class="col-input">
                        <input type="text" name="firstDispatcher" style="width: 180px;">
                    </td>
