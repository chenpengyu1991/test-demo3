...
<div class="toolbarsublist">
	<a href="javascript:void(0)" id="addEfcList" onclick="mumpsCase.popEfc()" ><b class="xinz">添加</b></a>
		...
		<c:forEach var="patients" items="${caseDto.idmListEfcList}" varStatus="status">
			<tr>
				...
				<td class="btnsublist" field="btn">
				    <a href="javascript:void(0)" onclick="mumpsCase.editTrs(this, 'efcList')">修改</a>&nbsp;
