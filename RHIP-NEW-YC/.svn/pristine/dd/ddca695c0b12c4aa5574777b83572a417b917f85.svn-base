			...
			<tr>
				...
				<td>
                        <c:choose>
                            ...
                            <c:when test="${postnatalFollowup.breastAnomalyFlag eq '1' && postnatalFollowup.breastAnomalyDesc eq null}"></c:when>
			...
			<tr>
				...
				<td>
                        <c:choose>
                            ...
                            <c:when test="${postnatalFollowup.lochiaAnomalyFlag eq '1' && postnatalFollowup.lochiaCondition eq null}"></c:when>
			...
			<tr>
				...
				<td colspan="3">
                        <c:choose>
                            ...
                            <c:when test="${postnatalFollowup.corpusAnomalyFlag eq '1' && postnatalFollowup.corpusAnomalyDesc eq null}"></c:when>
			...
			<tr>
				...
				<td colspan="3">
                        <c:choose>
                            ...
                            <c:when test="${postnatalFollowup.woundAnomalyFlag eq '1' && postnatalFollowup.woundAnomalyDesc eq null}"></c:when>
			...
			<tr>
				...
				<td colspan="3">
					<c:choose>
						...
						<c:when test="${postnatalFollowup.classifyFlag eq '1' && postnatalFollowup.classifyFlag eq null}"></c:when>
						<c:otherwise>异常 ${postnatalFollowup.classifyDesc}</c:otherwise>
					</c:choose>
				</td>
			</tr>
			<%--<tr>
