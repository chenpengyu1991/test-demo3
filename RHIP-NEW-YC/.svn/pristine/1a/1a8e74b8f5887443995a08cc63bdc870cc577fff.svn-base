...
<script src="${pageContext.request.contextPath}/js/views/ihm/cwhTarget/cwhOrg.js" type="text/javascript"></script>
<div class="section">
    <div class="toolbar">
        <div class="x-nav">
       <span class="layui-breadcrumb">
           ...
           <c:if test="${fn:contains(searchUrl,'baseCountList')}"><a><cite>儿保基础统计</cite></a></c:if>
           <c:if test="${fn:contains(searchUrl,'serviceCountList')}"><a><cite>儿保服务统计</cite></a></c:if>
           <c:if test="${fn:contains(searchUrl,'nutritionList')}"><a><cite>儿童营养评价</cite></a></c:if>
        </span>
        </div>
    </div>
        ...
        <form id="targetSearchForm">
            <table id="targetSearch">
                ...
                <tr>
                    ...
                    <td class="col-input">
                        <select name="genreCode" id="genreCode" >
                            <%--卫生局--%>
                    ...
                    <td class="col-input" colspan="2">
                        ...
                        <ehr:authorize ifAnyGranted="01">
                            ...
                            <%--市级医院--%>
                            <div id="byHospital">
                                <ehr:org-type-list id="organCode0" name="organCode0" type="hospital" subsid="0" value="${organCode}" code="${organCode}" width="200px"/>
                            </div>
                            <%--卫生院--%>
                            <div id="byCentre">
                            ...
                            <%--社区服务站--%>
                            <div id="byStation">
                                <ehr:dic-town-centre-station centreId="centre2" townId="town2" stationId="station2" centreName="superOrganCode2" stationName="organCode2" townName="gbCode2" width="200px" />
                            </div>
                        ...
                        <td class="col-input" colspan="2">
                            ...
                            <div id="byQuarter">
                                <input type="text" class="layui-input x-admin-sm-date" name="quarterDate" id="beginDate2" value="<fmt:formatDate value='${currentBeginDate}' pattern="yyyy"></fmt:formatDate>"
                                       style="width: 120px;padding-left: 0px;">
                                <select name="rangeQuarter" id="rangeQuarter" style="width: 120px;">
    ...
    <div id="resultChar" class="hide" style="height: 450px;overflow: auto;"></div>
</div>
