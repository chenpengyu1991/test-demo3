...
@Entity
@Table(name = "DA_PHARMACY_CANCEL_DETAIL")
public class PharmacyCancelDetail implements Serializable {
	...
	@Column(name = "CANCEL_PRICE", columnDefinition = "NUMBER|退药单价（出库价格）||",scale = 10, precision = 2, nullable = true)
	private BigDecimal cancelPrice;

	@Column(name = "CANCEL_NUM", columnDefinition = "NUMBER|退药数量||",scale = 10, precision = 2, nullable = true)
	private BigDecimal cancelNum;

	@Column(name = "CANCEL_AMOUNT", columnDefinition = "NUMBER|退药金额（退药单价×退药数量）||",scale = 10, precision = 2, nullable = true)
