...
<script type="text/javascript">
	 require(['views/uthealth/bloodSugar/search'],function(bloodSugar){
         bloodSugar.load();
	 });
</script>
...
<div class="section">
 <div class="searchbox">
	<form id="bloodSugarFormId" name="waterOilForm" action="" method="post">
		<table id="useSearchTableId">
               <colgroup>
				...
				<tr>
                    ...
                    <td class="cltext">血糖类别</td>
                    <td class="colinput">
                        <select  id="bglevel" name="bglevel">
                            <option value="" selected>请选择</option>
                            <option value="0">偏低</option>
                            <option value="1">正常</option>
                            <option value="2">高血糖</option>
                        </select>
                    </td>
					<td class="colinput">
         ...
         <table>
              <tr>
                  <td colspan="4" class="colbottom">
                         <span id="bloodSugarSearchSpanId" class="ico-bottom">&nbsp;</span>
                  </td>
              </tr>
         </table>
	</form>
