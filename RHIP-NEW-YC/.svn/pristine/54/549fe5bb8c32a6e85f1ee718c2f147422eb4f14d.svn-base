...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
	<table class="posttable">
		...
		<tr>
			...
			<td>
				<%--diOtherDiagnosisOrganFlag为2时是外地诊断--%>
				<c:if test="${brwDiseaseInfo.diOtherDiagnosisOrganFlag eq '2' }">
					${brwDiseaseInfo.diOtherDiagnosisOrganName}
				</c:if>
				<c:if test="${brwDiseaseInfo.diOtherDiagnosisOrganFlag ==null || brwDiseaseInfo.diOtherDiagnosisOrganFlag != '2' }">
					<ehr:org code="${brwDiseaseInfo.diDiagnosedOrganCode}"/>
				</c:if>
			</td>
		</tr>
		<tr>
...
<fieldset class="layui-elem-field">
	<legend><span style="font-size: 12px;font-weight: bolder;">确诊时并发症情况</span></legend>
		<table class="posttable">
		<colgroup>
			<col style="width: 15%;min-width:100px;" />
			<col style="width: 35%;min-width:200px;" />
...
<fieldset class="layui-elem-field">
	<legend><span style="font-size: 12px;font-weight: bolder;">糖尿病目前并发症情况</span></legend>
		<table class="posttable">
		<colgroup>
			<col style="width: 15%;min-width:100px;" />
		...
		<tr>
			...
			<c:if test="${brwDiseaseInfo.diCcomCoronaryFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomCoronaryTreatment}" ></c:out></ehr:tipWoldWrap></td>
			</c:if>
		</tr>
		<tr>
			<th>高血压</th>
			...
			<c:if test="${brwDiseaseInfo.diCcomHbpFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomHbpTreatment}" ></c:out></ehr:tipWoldWrap></td>
			</c:if>
		</tr>
		<tr>
			...
			<c:if test="${brwDiseaseInfo.diCcomHbcFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomHbcTreatment}" ></c:out></ehr:tipWoldWrap></td>
			</c:if>
		...
		<tr>
			...
			<c:if test="${brwDiseaseInfo.diCcomRetyFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomRetypTreatment}"></c:out></ehr:tipWoldWrap></td>
			</c:if>
		</tr>
		<tr>
			...
			<c:if test="${brwDiseaseInfo.diCcomNerveFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomNerveTreatment}"></c:out></ehr:tipWoldWrap></td>
			</c:if>
		</tr>
		<tr>
			...
			<c:if test="${brwDiseaseInfo.diCcomKidneyFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomKidneyTreatment}"></c:out></ehr:tipWoldWrap></td>
			</c:if>
		...
		<tr>
			...
			<c:if test="${brwDiseaseInfo.diCcomFootFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomFootTreatment}"></c:out></ehr:tipWoldWrap></td>
			</c:if>
		...
		<tr>
			...
			<c:if test="${brwDiseaseInfo.diCcomStrokeFlag eq '2'}">
				...
				<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><ehr:tipWoldWrap titleLength="40" ><c:out value="${brwDiseaseInfo.diCcomStrokeTreatment}"></c:out></ehr:tipWoldWrap></td>
			</c:if>
...
<fieldset class="layui-elem-field">
	<legend><span style="font-size: 12px;font-weight: bolder;">近期治疗情况</span></legend>
		<table class="posttable">
		<colgroup>
			<col style="width: 15%;min-width:100px;" />
			<col style="width: 20%;min-width:150px;" />
		...
		<tr>
			...
			<td>每次<c:out value="${brwDiseaseInfo.diRtHypDrugsperDose}" /><%--mg--%>
				<ehr:dic dicmeta="DMD00067" code="${brwDiseaseInfo.diRtHypDrugsperDoseUnit}" />
			</td>
		</tr>
		<tr>
			...
			<td>每次<c:out value="${brwDiseaseInfo.diRtInsulinPerDose}"/><%--单位--%>
				<ehr:dic dicmeta="DMD00067" code="${brwDiseaseInfo.diRtInsulinPerDoseUnit}"   />
			</td>
		</tr>
		</table>
	</fieldset>
