...
<script src="${pageContext.request.contextPath}/js/views/idm/statistics/report/monthReport/rabies/search.js" type="text/javascript"></script>
						...
						<tr>								
                            ...
                            <td class="colinput"  colspan="4">
                            	<ehr:authorize ifAnyGranted="${JKFYK}">
	    	                    	...
	    	                    	<input class="radioGroup" onclick="statisticsCommon.changeReportUnit(this.value)" id="reportUnitType83" name="reportUnitType" value="centre" type="radio" ><label for="reportUnitType83">中心</label>
    	                    	</ehr:authorize>                              
