...
<script src="${pageContext.request.contextPath}/js/views/cdm/standardization/healthCard/statistics.js" type="text/javascript"></script>
<div class="section">
	<div class="toolbar">
		...
		<form method="post" id="form_search">
			<table id="reportSearch">
				...
				<tr id="orgFollowupTrId">
					...
					<button class="layui-btn layui-btn-sm" id="statisticsSearchId"  style="float: left;" name="search"><i class="layui-icon">&#xe615;</i>查询</button>
					</td>
				</tr>
				<tr id="villageFollowupTrId" style="display: none">
					...
					<td style="text-align: center;">
					<%-- <input class="search_btn" type="button" name="search" onclick="followupStatistics.pagination(1)" value="查询" style="float: left;"/> --%>
					<button class="layui-btn layui-btn-sm"  id="statisticsSearchId2"  style="float: left;" name="search"><i class="layui-icon">&#xe615;</i>查询</button>
					</td>
				</tr>
				</tbody>
			</table>
