 ...
 * @author Gavin King
 */
public class PropertyAccessException extends BaseException {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5842373028213914543L;
    ...
    public String getMessage() {
		...
		StringUtil.qualify( persistentClass.getName(), propertyName );
	}
}
