...
@Entity
@Table(name = "MHM_DRUG_PRICE")
public class MhmDrugPrice implements Serializable {
	...
	@Column(name = "DRUG_ID", columnDefinition = "NUMBER|药品ID（药物表的ID字段）|11|", length = 11, nullable = true)
	private Long drugId;

	@Column(name = "PRICE", columnDefinition = "NUMBER|总价格||", scale = 5, precision = 2, nullable = true)
	private BigDecimal price;
	
	@Column(name = "UNIT_PRICE", columnDefinition = "NUMBER|单位价格||", scale = 5, precision = 2, nullable = true)
	private BigDecimal unitPrice;

	@Column(name = "START_DT", columnDefinition = "DATE|开始价格时间||", nullable = true)
	...
	@Column(name = "END_DT", columnDefinition = "DATE|结束价格时间||", nullable = true)
	private Date endDt;
