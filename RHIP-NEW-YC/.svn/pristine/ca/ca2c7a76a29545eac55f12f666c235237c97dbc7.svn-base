...
public class PaginationTag extends TagSupport {
	...
	private String getPageSelect(ServletRequest request,Page pg){
		...
		StringBuilder sb = new StringBuilder("<select  class='x-layui-input' onchange=\"");
		sb.append("pageUtil.changePageSize(this,'" + pg.getUrl() + "');" + action + "(" + params + "1)" + "\">");
//		sb.append("pageUtil.changePageSize(this,'" + pg.getUrl() + "','" + this.action + "')\">");
