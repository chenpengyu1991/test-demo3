...
public final class RequestUtil {
	...
	public static <T> T getModel(Class<T> clazz, HttpServletRequest request) {
		Map<String, Object[]> map = request.getParameterMap();
		return BeanUtil.getBean(clazz, map);
	}

	@SuppressWarnings("unchecked")
	public static Criteria getCriteria(HttpServletRequest request) {
		return BeanUtil.getCriteria(request.getParameterMap());
	}
}
