package com.founder.fasf.filter;
...
public class LocaleFilter extends OncePerRequestFilter
{
            ...
            throws IOException, ServletException
    {
        ...
        if (session != null)
        {
            ...
            {
                preferredLocale = (Locale) session.getAttribute(CoreConstants.PREFERRED_LOCALE_KEY);
            }
            else
            {
                session.setAttribute(CoreConstants.PREFERRED_LOCALE_KEY,
                        preferredLocale);
        ...
        {
            Map<String, Object> config = (Map<String, Object>) getServletContext().getAttribute(
                    CoreConstants.CONFIG);
            config.put(CoreConstants.CSS_THEME, theme);
        }
