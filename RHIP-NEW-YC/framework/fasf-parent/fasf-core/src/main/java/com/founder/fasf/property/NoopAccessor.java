...
public class NoopAccessor implements PropertyAccessor {
	 ...
	 * {@inheritDoc}
	 */
	public Getter getGetter(Class<?> arg0, String arg1) throws BaseException {
	 ...
	 * {@inheritDoc}
	 */
	public Setter getSetter(Class<?> arg0, String arg1) throws BaseException {
	...
	private static class NoopGetter implements Getter {
		...
		public Object getForInsert(Object target, Map map)
