...
public class BasicPropertyAccessor implements PropertyAccessor {
    ...
    //private static final Logger LOG = Logger.getLogger( BasicPropertyAccessor.class.getName());
...
//							propertyName
	...
	private static BasicSetter getSetterOrNull(Class<?> theClass, String propertyName) {
		...
		if (method!=null) {
			if ( !ReflectUtil.isPublic(theClass, method) ) method.setAccessible(true);
	...
	public static Getter createGetter(Class<?> theClass, String propertyName) throws BaseException {
	...
	private static BasicGetter getGetterOrNull(Class<?> theClass, String propertyName) {
		...
		if (method!=null) {
			if ( !ReflectUtil.isPublic( theClass, method ) ) {
